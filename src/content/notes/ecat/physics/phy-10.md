...
subjectName: Physics
topic: phy-10
topicName: Electrostatics and Electric Field
weight: 5
country: pakistan
...
For multiple charges, total field/potential is vector/scalar sum:
$$\vec{E}_{total} = \sum \vec{E}_i$$
$$V_{total} = \sum V_i \quad \text{(algebraic sum)}$$
...
Energy density in electric field (in vacuum):
