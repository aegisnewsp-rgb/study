...
topic: chem-3
topicName: "Chemical Bonding: Ionic, Covalent and Metallic"
weight: 5
country: nigeria
generated: "2026-03-24T08:32:07.686845"
diagramPrompt: "Clear scientific diagram of Chemical Bonding: Ionic, Covalent and Metallic with atom labels, molecular structure, reaction arrows, white background, color-coded bonds and groups, exam textbook style"
...
Formed by complete transfer of electrons from a metal to a non-metal. The metal loses electrons (oxidation), the non-metal gains them (reduction).
...
**The Octet Rule:**
Atoms tend to gain, lose, or share electrons to achieve 8 valence electrons (except hydrogen = 2).
...
The enthalpy of formation of an ionic compound is the sum of several steps:
$$\Delta H_f = \Delta H_{\text{atomisation}} + \Delta H_{\text{ionisation}} + \Delta H_{\text{electron affinity}} + \Delta H_{\text{lattice}}$$
...
5. Form lattice: $\Delta H = −784$ kJ/mol (lattice energy)
$$\Delta H_f = 107 + 496 + 122 - 349 - 784 = -408 \text{ kJ/mol}$$
...
Antibonding orbitals ($\sigma^*$, $\pi^*$) are higher in energy than bonding orbitals ($\sigma$, $\pi$). Bond order:
$$\text{Bond order} = \frac{\text{electrons in bonding} - \text{electrons in antibonding}}{2}$$

For O₂: Bond order = $(10 - 6)/2 = 2$ (double bond, paramagnetic — has 2 unpaired electrons, confirmed experimentally).
For N₂: Bond order = $(10 - 4)/2 = 3$ (triple bond, diamagnetic).
