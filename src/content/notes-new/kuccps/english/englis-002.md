...
Core concept: Topic 2 is an important topic in ('english', 'English') for KUCCPS (Kenya)
...
Overview: Topic 2 is a key ('english', 'English') topic for KUCCPS (Kenya)
...
Full coverage: Topic 2 in ('english', 'English') for KUCCPS (Kenya) preparation
