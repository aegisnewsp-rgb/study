...
topic: chemis-012
topicName: Biomolecules (Carbohydrates & Proteins)
weight: 3
country: slmc
...
**Cellulose** cannot be digested by humans (we lack β-1,4 cellulase) — dietary fiber.
**Starch** (amylose + amylopectin) IS digestible — broken down by salivary and pancreatic amylase.
...
**Protein**: functional polypeptide (typically >50 amino acids, or specifically folded)
...
**α-helix**: 3.6 amino acids per turn; H-bond between C=O(i) and N–H(i+4) — intramolecular H-bonding
**β-sheet**: H-bond between C=O and N–H of adjacent strands — can be parallel or antiparallel
