...
S → looks like a reversed S (Ƨ) — it does change in a mirror
...
- Wrongly assuming S (or Z) stays the same in a mirror — both actually flip to a reversed S (Ƨ) and reversed Z, because they have only rotational, not reflective, symmetry.
...
| S | Ƨ or reversed S | Changes — only rotational symmetry, not reflective |
...
| Z | reversed Z | Changes — only rotational symmetry, not reflective |
...
S → Ƨ (reversed S — it changes)
C → ɔ (reversed C)
C → ɔ
G → ɔ (reversed G)
L → ɾ (turned L)
Mirror image (reading left to right, order reversed): ɾɔɔɔƧ
...
**⚡ Advanced Exam Tip:** When a letter sequence contains S or Z, do NOT assume they stay the same. Unlike A, H, I, M, O, T, U, V, W, X, Y — which have a true vertical line of symmetry and look identical in a mirror — the letters S and Z have only point (180°) symmetry, not reflective symmetry. So in a vertical (left-right) mirror, S becomes a reversed S (Ƨ) and Z becomes a reversed Z — they DO change. Many candidates wrongly treat S as "always S"; holding a capital S up to a mirror confirms it reads backwards. Memorise the true no-change set (A, H, I, M, O, T, U, V, W, X, Y) so you can quickly flag every other letter — including S and Z — as one that flips, eliminating wrong options in letter sequence questions.
