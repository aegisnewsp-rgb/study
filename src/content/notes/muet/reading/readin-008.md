...
Critical reading means **reading actively and analytically** — questioning the text rather than accepting everything at face value. You evaluate: Is this argument logical? Is the evidence credible? What is the author's agenda?

**What is Author's Purpose?**
The author's purpose is **why** they wrote the passage. Common purposes:
...
**⚡ Exam Tip**
Questions asking "What is the author's purpose?" or "What is the author's attitude toward X?" require you to go beyond surface facts and read the text's tone and intent.
...
1. **Word choice (diction)** — Emotional or evaluative words reveal the author's stance.
   > "The government **callously ignored** the plight of flood victims." (Persuade — negative)
   > "The government implemented a policy change in response to flood events." (Inform — neutral)

2. **Evidence selection** — What the author chooses to include or omit shapes the argument.
...
3. **Presence of counter-arguments** — If the author acknowledges and rebuts opposing views, the purpose is argumentative (persuade). If the author merely describes different viewpoints without advocating one, the purpose is to inform or compare.

4. **Structural signals** — A strongly argumentative structure (thesis → arguments → conclusion) suggests persuasion. A structure that defines, classifies, or describes suggests information.
...
> "The government slashed education funding, leaving thousands of children without hope."
"Slashed" and "without hope" are emotionally charged. The neutral version: "The government reduced education funding by 15%."
...
> "Studies show that people are increasingly concerned about their health."
"How many studies?" "Which people?" "How concerned?"

### 5. False Authority
Citing celebrities, unnamed "experts," or irrelevant authorities to add credibility.
> "According to a well-known actor, the new healthcare policy will benefit millions."
An actor is not a healthcare expert.
...
1. Ask: "Is this all the relevant data, or just the data that fits the author's argument?"
2. Look for hedging language around data: if the author only presents favourable statistics, the unfavourable data may be suppressed.
3. Check the date range of data: selecting only years when a trend looked good while ignoring other periods.
...
### Practical Framework
1. **Before reading**: Note the title and any introduction. What do you expect this passage to be about?
2. **First read**: Get the overall gist. What is the author trying to do — inform, persuade, describe?
3. **Second read**: Note the tone. Where does the tone shift? What does this reveal about the author's purpose?
4. **Evaluate**: What evidence is provided? Is it credible? Is anything missing? What is the author's underlying assumption?
5. **Answer**: Use your analysis of purpose, tone, and audience to answer inference and evaluation questions.
