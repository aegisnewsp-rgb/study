...
If $\triangle ABC \sim \triangle DEF$ with scale factor $k$, then area ratio = $k^2$.

**Pythagoras' Theorem:**
In a right-angled triangle with hypotenuse $c$: $a^2 + b^2 = c^2$.
Converse: If $a^2 + b^2 = c^2$, the triangle is right-angled at the angle opposite side $c$.
...
The internal angle bisector of angle $A$ divides the opposite side $BC$ in the ratio $AB:AC$.
...
**Circle Theorems:**
1. Angle subtended by a diameter at the circumference is a right angle (Thales' theorem)
2. Angles subtended by the same chord at the circumference are equal
3. The angle between a chord and a tangent equals the angle in the alternate segment
4. The perpendicular bisector of a chord passes through the centre
5. Equal chords subtend equal angles at the centre

**Area of Similar Figures:**
If two similar figures have corresponding lengths in ratio $k:1$, then:
- Area ratio = $k^2:1$
- Volume ratio = $k^3:1$
