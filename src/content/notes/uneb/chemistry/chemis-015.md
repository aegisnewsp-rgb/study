...
topic: chemis-015
topicName: Classification of Polymers (2)
weight: 3
country: uganda
...
1. **Initiation:** initiator (e.g. organic peroxide) → R• + R•
2. **Propagation:** R• adds to monomer, new radical attacks next monomer — chain grows.
3. **Termination:** two radicals combine or disproportionate, ending the chain.
...
1. Draw the repeat unit of the polymer formed when methyl 2-methylpropenoate (methyl methacrylate) polymerises, and name the product. State one use.
2. Terylene is made from ethane-1,2-diol and benzene-1,4-dicarboxylic acid. Write the condensed polymerisation equation (showing the by-product) and state the type of linkage formed.

---

## Continue your study

- **[View this topic in your UNEB UACE (Uganda) roadmap](/roadmap/?exam=uneb&duration=1mo)** — see where "Topic 15" fits in your personalised plan
