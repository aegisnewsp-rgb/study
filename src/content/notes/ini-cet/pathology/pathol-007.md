...
**Wiskott-Aldrich Syndrome (WAS)**: X-linked triad: **W**iskott (thrombocytopenia with small platelets), **A**ldrich (eczema), **S**yndrome (recurrent infections). WAS protein (WASP) is important for cytoskeletal reorganization in hematopoietic cells.
