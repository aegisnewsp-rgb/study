...
diagramPrompt: "Mathematical diagram showing Circle, Parabola, Ellipse and Hyperbola concept with coordinate axes, labeled points, geometric shapes shaded appropriately, clean black and white style"
...
**The Parabola:**
The locus of points equidistant from a fixed point (focus) and a fixed line (directrix).
...
**The Ellipse:**
The locus of points where the sum of distances to two fixed points (foci) is constant.
...
**The Hyperbola:**
The locus of points where the absolute difference of distances to two fixed points (foci) is constant.
...
For parabola $y^2 = 4ax$ at point $(at^2, 2at)$:
