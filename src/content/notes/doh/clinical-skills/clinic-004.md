...
topic: clinic-004
topicName: Medication Administration and Safety
weight: 3
country: doh
...
**A. Basic dose calculation:**
Desired dose ÷ Available dose × Quantity = Volume to administer
*Example: Doctor orders 500 mg; available is 250 mg/5 mL. Answer: 500 ÷ 250 × 5 = 10 mL*

**B. IV drip rate:**
(Volume × Drop factor) ÷ Time in minutes = drops/min
*Example: 1 L over 8 hours using macrodrip (20 drops/mL): (1000 × 20) ÷ 480 = 41.7 ≈ 42 drops/min*
...
1. **Stay calm** — patient safety is the priority
2. **Assess the patient immediately** — monitor for adverse effects
3. **Notify the physician** — some errors require immediate antidote or intervention
4. **Document the error** — factually and completely (what happened, when, to whom, what was done)
5. **Complete an incident report** — per UAE MOHAP/DOH protocol
6. **Inform the charge nurse/nurse manager**
7. **Do NOT hide or cover up the error** — this is unprofessional, illegal, and can result in licence revocation
...
**A. Traditional and Herbal Medicine**
Many patients in the UAE use traditional remedies alongside prescribed medications:
...
The UAE has strict regulations on controlled substances (Federal Law No. 4 of 1983 on Pharmaceutical Practice and the Ministry of Health regulations). Nurses must:
...
**C. Patient Education**
For discharge medication counselling in UAE:
