...
**Section 36**: RBI can order special audit
**Section 35A**: RBI can give directions to banks in public interest
**Section 36AAA**: RBI can remove managerial personnel from banks

**Power to Supersede Board (Section 36AC)**:
RBI can supersede the board of a bank for up to 5 years if:
