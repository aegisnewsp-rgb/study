...
### Quick Example
**Q:** An article is sold for ₹360 at a loss of 10%. Find the cost price.
A: SP = CP × (100 − Loss)/100 → 360 = CP × 0.90 → CP = 360 ÷ 0.90 = **₹400**

**Q:** A shopkeeper offers a 15% discount on an article with MP of ₹800 and still makes a 20% profit. Find the CP.
A: SP after discount = 800 × 0.85 = ₹680. Since profit = 20%: SP = CP × 1.20 → CP = 680 ÷ 1.20 = **₹566.67**
...
### Worked Example
**Q:** A shopkeeper buys an article at 20% below its marked price. He sells it at a 10% discount on the marked price. Find his profit percent.
**Approach:** Let MP = ₹100. CP = 100 − 20% of 100 = ₹80. SP = 100 − 10% of 100 = ₹90. Profit = 90 − 80 = ₹10 on CP ₹80. Profit% = 10/80 × 100 = 12.5%.
**Answer:** 12.5%
