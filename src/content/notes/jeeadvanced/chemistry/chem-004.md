...
weight: 4
country: india
generated: "2026-03-24T08:32:07.922275"
...
M methane ($n=1$), ethane ($n=2$), propane ($n=3$), butane ($n=4$)...
Each step up adds $CH_2$ and 14 g/mol to the molar mass.
...
Both contain the carbonyl group ($C=O$). Aldehyde has H attached to carbonyl carbon; ketone has two carbon groups. Both undergo nucleophilic addition reactions (with HCN, $NaHSO_3$, Grignard reagents, etc.).
...
**Aldol Condensation:**
Base-catalysed aldol condensation between two aldehydes (or ketones):
...
**Cannizzaro Reaction:**
Non-enolizable aldehydes (no $\alpha$-hydrogen) undergo disproportionation with concentrated base:
$2HCHO + NaOH \to CH_3OH + HCOONa$
This is the cross Cannizzaro (formaldehyde + non-enolizable aldehyde).
