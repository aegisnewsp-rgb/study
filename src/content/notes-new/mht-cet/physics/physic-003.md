...
Core concept: Topic 3 is an important topic in ('physics', 'Physics') for MHT-CET
...
Overview: Topic 3 is a key ('physics', 'Physics') topic for MHT-CET
...
Full coverage: Topic 3 in ('physics', 'Physics') for MHT-CET preparation
