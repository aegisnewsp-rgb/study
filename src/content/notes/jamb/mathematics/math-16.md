...
diagramPrompt: "Mathematical diagram showing Vectors in Two Dimensions concept with coordinate axes, labeled points, geometric shapes shaded appropriately, clean black and white style"
...
Core concept: Vectors in Two Dimensions is a key topic in this subject area
...
**Vectors in Two Dimensions** — Study Guide
Overview: Vectors in Two Dimensions is part of the core syllabus
...
**Vectors in Two Dimensions** — Comprehensive Notes
Full coverage: Vectors in Two Dimensions with detailed explanation
