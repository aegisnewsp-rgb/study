...
| Condition | Target SpO₂ | Initial Device |
|---|---|---|
...
| Cardiac arrest | 98–100% | Bag-valve-mask with reservoir |
...
| Device | FiO₂ Delivered | Flow Rate | Best For |
|---|---|---|---|
| **Nasal cannula** | 24–44% | 1–6 L/min | Mild hypoxia; COPD; long-term |
| **Simple face mask** | 40–60% | 5–8 L/min | Moderate hypoxia; short-term |
| **Venturi mask** | 24–50% (precise %) | As per colour-coded adapter | COPD (precise FiO₂ control) |
| **Non-rebreather mask** | 80–95% | 10–15 L/min | Severe hypoxia; trauma |
| **High-flow nasal cannula (HFNC)** | 21–100% | Up to 60 L/min | Acute hypoxaemic respiratory failure |
...
**Oxygen Cascade:**
Atmospheric air (21% O₂) → Trachea → Bronchi → Bronchioles → Alveoli → Pulmonary capillaries → Left heart → Systemic arteries → Capillaries → Tissues
...
The S-shaped curve shows how haemoglobin binds and releases oxygen:
...
Increasingly used in UAE ICUs for acute hypoxaemic respiratory failure:
...
| Finding | pH | PaCO₂ | HCO₃⁻ |
|---|---|---|---|
| Respiratory acidosis | ↓ | ↑ | Normal (acute) or ↑ (chronic compensation) |
| Respiratory alkalosis | ↑ | ↓ | Normal (acute) or ↓ (chronic compensation) |
...
**Home Oxygen Therapy:**
Some UAE patients require long-term oxygen therapy (LTOT). Criteria:
