...
⚡ **NEET Memory Aid for Embryo Sac (7 cells, 8 nuclei):** Remember "**3 + 1 + 3**" from the micropylar to the chalazal end — **3** cells at the micropylar end (egg apparatus = 1 egg cell + 2 synergids), **1** central cell in the middle (holding 2 polar nuclei), and **3** antipodal cells at the chalazal end. That gives 7 cells but 8 nuclei, because only the central cell breaks the "1 cell = 1 nucleus" pattern — which is exactly why the embryo sac is 8-nucleate yet 7-celled.
