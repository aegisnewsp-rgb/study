...
topic: medica-003
topicName: Basic Pharmacology and Drug Classifications
weight: 3
country: doh
...
|---|---|---|
| **A**bsorption | Drug enters bloodstream | Route matters; first-pass metabolism reduces oral bioavailability |
| **D**istribution | Drug spreads through body compartments | Protein binding; blood-brain barrier; fat solubility |
| **M**etabolism | Drug chemically changed (liver) | Enzyme induction/inhibition; prodrugs activated |
| **E**xcretion | Drug eliminated (kidneys, liver, lungs) | Renal/hepatic impairment = dose adjustment |
