...
**Theoretical Foundation**: The Gregorian calendar system was introduced in 1582 by Pope Gregory XIII to correct the Julian calendar's drift. It reached India in 1752, when Britain and its colonies switched from the Julian to the Gregorian system, and it remained the standard civil calendar through the British period. In 1957, independent India's Calendar Reform Committee additionally introduced the Indian national Saka calendar for civil use alongside the Gregorian. For SSC CGL, calendar questions test rigorous modular arithmetic under time pressure.
...
- Over the 20th century (1901–2000), 1st January does not favour any single weekday; it occurs most often on Wednesday and Friday (15 times each)
