...
|---------|-----------|-----------------|
| Current Account | Trade (goods) | Negative = deficit |
| Current Account | Services | Net services |
| Current Account | Income | Net income receipts |
| Current Account | Transfers | Net transfers |
| Capital Account | FDI (net) | Inflows positive |
| Capital Account | FPI (net) | Inflows positive |
| Capital Account | ECBs | Net borrowing |
| Capital Account | Banking capital | Net flows |
...
**Quota System**: Each member has a quota based on economic size
...
**Headquarters**: Washington D.C.
**President**: Ajay Banga (Indian-origin; since 2023)
...
**Role**: Bank of central banks; hosts Basel Committee on Banking Supervision
...
**Purpose**: Promoting economic development in Asia
