...
const exam: ExamTemplate = {
  ...
  examPattern: `Historically, the AIIMS MBBS examination typically consisted of 200 multiple-choice questions (MCQs) divided across four sections: Physics (60 questions), Chemistry (60 questions), Biology (60 questions including Botany and Zoology), and General Knowledge/Aptitude (20 questions) over roughly 3 hours and 30 minutes as documented in official AIIMS admission bulletins prior to merging into NEET UG. Each correct answer was typically awarded 1 mark. The examination was conducted in a computer-based (CBT) format at designated test centres across India. Questions were designed to test comprehension, application, and analytical skills rather than mere recall.`,
  eligibility: `Candidates historically were required to complete the 10+2 or equivalent examination with Physics, Chemistry, Biology, and English as compulsory subjects from a recognized board. A minimum aggregate of approximately 60% marks in Physics, Chemistry, and Biology (PCB) was required for general category, with 50% for SC/ST and 55% for OBC candidates as specified in official historical AIIMS criteria. The upper age limit was typically 25 years for general category with 5-year relaxations for SC/ST/OBC candidates. Only Indian citizens and Overseas Citizens of India (OCI) were eligible to appear for the examination.`,
  subjects,
    durations: {
