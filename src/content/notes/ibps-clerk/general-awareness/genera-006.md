...
**1. Production (Output) Approach:** Sum of the value added at each stage of production across all sectors.
GDP = Σ (Value of Output − Intermediate Costs) = Gross Value Added (GVA) + Indirect Taxes − Subsidies

**2. Income Approach:** Sum of all incomes earned in the production of GDP (wages, profits, rents, interest).
...
India typically runs a **current account deficit (CAD)** — imports exceed exports. India's CAD was approximately 1-2% of GDP in recent years, which is considered manageable.
