...
1. Subject-verb agreement ✓
2. Tense and verb form ✓
3. Pronoun-antecedent agreement ✓
4. Article usage ✓
5. Preposition choice ✓
6. Parallel structure ✓
7. Word order ✓
8. Comparison errors ✓
9. Redundancy/tautology ✓
...
**Parallel Structure — Key Rule:**
Elements connected by "and," "or," or "but" must be in the same grammatical form.
...
**1. The Gerund vs. Infinitive Trap**
Both gerunds and infinitives can follow certain verbs, but some verbs strongly prefer one over the other.
...
**2. The subjunctive mood — frequently tested but rarely mastered**
After verbs of suggestion, demand, recommendation, and requirement, the subjunctive uses the base form of the verb:
...
**3. The "None" Problem**
"None" historically meant "not one" (singular) and is still treated as singular by most formal testing authorities, including HAT-UG:
