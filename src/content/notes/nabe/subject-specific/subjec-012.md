...
**Quadratic Equations** — Key Facts for NABE (Pakistan)
...
## Quadratic Equations — NABE (Pakistan) Study Guide
...
## Quadratic Equations — Comprehensive NABE (Pakistan) Notes
...
**Number Problem**:
**Example**: Find two consecutive integers whose product is 182.
...
**Area Problem**:
**Example**: Rectangular garden perimeter is 60m and area is 216 m². Find dimensions.
...
**To find common root of two quadratics**:
If x² + ax + b = 0 and x² + cx + d = 0 have a common root:
