...
**Topic 2** — Key Facts for XAT
Core concept: Topic 2 is an important topic in ('varc', 'VARC') for XAT
High-yield point: Understand the fundamental principles and their applications
⚡ Exam tip: Questions from Topic 2 appear regularly in XAT
...
**Topic 2** — XAT Study Guide
Overview: Topic 2 is a key ('varc', 'VARC') topic for XAT
...
**Topic 2** — Comprehensive XAT Notes
Full coverage: Topic 2 in ('varc', 'VARC') for XAT preparation
