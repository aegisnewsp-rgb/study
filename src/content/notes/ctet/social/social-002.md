...
| Range | Also Known As | Key Features |
|---|---|---|
| **Greater Himalayas** (Himadri) | High Himalayas | Highest peaks — including Mt. Everest (8,849m, Nepal), K2; permanent snow |
| **Lesser Himalayas** (Himachal) | Middle Himalayas | 2,000–3,000 m elevation; popular hill stations (Shimla, Mussoorie) |
| **Shivalik Hills** (Outer Himalayas) | Sub-Himalayas | Lowest, outermost range; composed of young, soft rock |
