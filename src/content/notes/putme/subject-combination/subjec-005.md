...
**Operations**: (a × 10ᵐ) × (b × 10ⁿ) = (a × b) × 10ᵐ⁺ⁿ
...
**Example**: Solve 5^(x+2) − 5^x = 600
5^x(25 − 1) = 600 → 5^x × 24 = 600 → 5^x = 25 = 5² → **x = 2**

## Nested Surds

**Example**: Simplify √(6 + 2√5)
Let √(6 + 2√5) = √a + √b where a+b = 6 and ab = 5
t² − 6t + 5 = 0 → (t−1)(t−5) = 0 → t = 1 or 5
So √(6 + 2√5) = √5 + 1
