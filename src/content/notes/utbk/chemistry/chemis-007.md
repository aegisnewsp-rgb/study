...
1. n(H₂) = 4.0 / 2.0 = 2.0 mol; n / coefficient = 2.0 / 2 = 1.0.
2. n(O₂) = 32.0 / 32.0 = 1.0 mol; n / coefficient = 1.0 / 1 = 1.0.
3. The ratios tie, so both reactants are fully consumed. Theoretical H₂O = 2.0 mol × 18 g/mol = **36 g**.
...
1. A 25.0 mL solution of 0.150 M NaOH is diluted to 250 mL. Calculate the new molarity and the mass of NaOH originally dissolved.
2. Combustion of 1.20 g of an unknown hydrocarbon (CₓHᵧ) produces 3.52 g CO₂ and 1.44 g H₂O; the molar mass is 84 g/mol. Determine the empirical and molecular formulas.

---

## Continue your study

- **[View this topic in your UTBK/SNPMTN (Indonesia) roadmap](/roadmap/?exam=utbk&duration=1mo)** — see where "Topic 7" fits in your personalised plan
