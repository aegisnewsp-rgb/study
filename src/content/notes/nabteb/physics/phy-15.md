...
weight: 4
country: nigeria
generated: "2026-03-24T08:32:07.565567"
...
#### Common Mistakes
1. Dropping the negative sign in F = -kx — examiners use this to test whether students recognise directionality.
2. Applying T = 2π√(L/g) to a spring or vice versa — each formula belongs to one system.
3. Conflating angular frequency ω (rad s⁻¹) with frequency f (Hz): they differ by the factor 2π.
...
#### Worked Example
A 0.50 kg mass on a spring oscillates with T = 0.80 s. Find k.
Solution: T = 2π√(m/k) → k = 4π²m/T² = 4π²(0.50)/(0.64) ≈ **30.8 N m⁻¹**.
