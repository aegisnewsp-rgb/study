...
Tyrosine → (tyrosine hydroxylase) → **L-DOPA** → (DOPA decarboxylase) → **Dopamine** → (DβH — dopamine β-hydroxylase) → **Norepinephrine** → (PNMT — phenylethanolamine-N-methyltransferase) → **Epinephrine**
