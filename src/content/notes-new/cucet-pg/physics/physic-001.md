...
Core concept: Topic 1 is an important topic in ('physics', 'Physics') for CUCET (PG)
...
Overview: Topic 1 is a key ('physics', 'Physics') topic for CUCET (PG)
...
Full coverage: Topic 1 in ('physics', 'Physics') for CUCET (PG) preparation
