...
Electrons fill shells starting from innermost (K=1):
...
**Bohr Notation Example:**
For Silicon (Z=14): 2, 8, 4 or written as [Ne] 3s² 3p²
...
Or condensed: [Ar] 3d⁶ 4s²

**d-Block Contraction:**
After filling d-orbitals, atomic radius decreases slightly. This affects properties of elements following d-block.
