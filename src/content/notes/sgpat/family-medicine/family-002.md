...
topic: family-002
topicName: The four PHC principles in the Saudi
weight: 3
country: saudi
...
| Principle | What it means at PHC |
|---|---|
| First-contact | Every entry to the health system starts here |
| Accessibility | Geographic, financial, cultural reach |
| Comprehensiveness | All ages, sexes, conditions, organ systems |
| Continuity | Longitudinal relationship over time |
...
| Level | Target | Example at PHCC |
|---|---|---|
| Primordial | Whole-population risk factors | Community salt-reduction campaigns |
| Primary | Healthy individuals, remove risk | Smoking-cessation counselling |
| Secondary | Early disease detection | BP, HbA1c, mammography screening |
| Tertiary | Reduce complications | Diabetic foot clinic, CKD follow-up |
| Quaternary | Protect from over-medicalisation | Avoiding unnecessary antibiotics in URTI |

#### EBM at the bedside

A PICO question frames the problem (**P**opulation, **I**ntervention, **C**omparator, **O**utcome). Appraising requires checking the study design, confidence intervals, and number-needed-to-treat (NNT) before applying to the individual patient in front of you.
...
- **[View this topic in your Saudi GP Board roadmap](/roadmap/?exam=sgpat&duration=1mo)** — see where "Topic 2" fits in your personalised plan
