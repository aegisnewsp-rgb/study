...
Core concept: Topic 1 is an important topic in ('chemistry', 'Chemistry') for CUCET (PG)
...
Overview: Topic 1 is a key ('chemistry', 'Chemistry') topic for CUCET (PG)
...
Full coverage: Topic 1 in ('chemistry', 'Chemistry') for CUCET (PG) preparation
