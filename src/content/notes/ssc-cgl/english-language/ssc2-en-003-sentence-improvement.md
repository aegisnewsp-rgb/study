...
topic: ssc2-en-003-sentence-improvement
topicName: "Sentence Improvement"
tier: unified
weight: 2
weight_unit: "% of Tier 2 paper"
diagramPrompt: "A decision matrix for sentence improvement with 5 criteria (Grammar, Idiom, Conciseness, Meaning Preservation, Register) each rated for Option A through D"
country: india
...
### Memory Trick
**GIST**: **G**rammar → **I**diom/Preposition → **S**tyle (conciseness) → **T**ense/Agreement. Check in this order.
...
### Quick Example
Q: He has been working here since ten years.
A: **"for ten years"** — "since" is used with a specific point in time (since 2010, since Monday). "For" is used with a duration (for ten years).
...
### Worked Example
**Q:** He is having a bath.
(a) He is having a bath. (Original)
...
**Category 1: Grammatical Correction**
These are the most common improvements. They involve correcting verb form, tense, subject-verb agreement, or part of speech errors.

Example: "He is superior than his brother in mathematics."
→ "He is superior to his brother" — "superior" takes "to," not "than." (Idiom + grammar)
Example: "The reason is because he was ill."
→ "The reason is that he was ill." — "The reason is" must be followed by "that," not "because."

**Category 2: Prepositional/Idiomatic Correction**
SSC has a predictable set of preposition pairs it tests. These are high-value memorisation items:
...
**Category 3: Conciseness Improvement**
SSC loves testing the elimination of redundant words. The principle: if two words convey the same meaning and one is shorter without loss of clarity, prefer the shorter one.
...
**Category 4: Tense/Verb Form in Complex Sentences**
SSC tests subtle tense distinctions that Indian English learners commonly miss:
...
**Q1:** He has been working in this office since ten years.
(a) for ten years
(b) since ten years
(c) for ten years now
(d) since ten years ago
...
**Q3:** It is necessary that the report is submitted before Friday.
(a) is submitted
(b) be submitted
(c) was submitted
(d) were submitted
