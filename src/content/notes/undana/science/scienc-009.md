...
topic: scienc-009
topicName: Mendel's Laws and Cross Patterns
weight: 3
country: indonesia
...
#### Sex-Linked Inheritance and Pedigree Logic
...
#### Practice Prompts
1. In a population, 16% of individuals display a recessive phenotype. Using **p + q = 1** and **p² + 2pq + q² = 1**, compute the frequency of heterozygous carriers.
2. A red-green colour-blind man marries a carrier woman. Construct a Punnett square and state the expected phenotypic ratio among their sons.
