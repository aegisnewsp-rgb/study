...
Core concept: Topic 3 is an important topic in ('physics', 'Physics') for Saudi Medical Exam
...
Overview: Topic 3 is a key ('physics', 'Physics') topic for Saudi Medical Exam
...
Full coverage: Topic 3 in ('physics', 'Physics') for Saudi Medical Exam preparation
