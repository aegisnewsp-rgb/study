...
**Alimentary Canal (Gastrointestinal Tract) — Complete Pathway:**
...
Three parts: Duodenum (first 25 cm) → Jejunum (~2.5 m) → Ileum (~3.5 m)
...
**Fat Digestion:**
Fats → (bile emulsification) → Fat droplets → (pancreatic lipase) → Fatty acids + Glycerol
→ Micelles → absorbed by intestinal cells → reassembled into triglycerides → enter lymphatic system (lacteals) → transported as chylomicrons
