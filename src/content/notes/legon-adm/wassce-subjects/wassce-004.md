...
Step 2: Value of 1 part = GH₵ 2,400 ÷ 8 = GH₵ 300
Step 3: Ama receives 3 × 300 = **GH₵ 900**
Step 4: Kofi receives 5 × 300 = **GH₵ 1,500**
Verification: 900 + 1,500 = 2,400 ✓
...
Cost of 1 textbook = 640 ÷ 8 = GH₵ 80
Cost of 5 textbooks = 5 × 80 = **GH₵ 400**

Method 2 — Ratio method:
8:5 = 640:x → 8/5 = 640/x → x = (640 × 5) ÷ 8 = **GH₵ 400**
...
Since workers increase, days decrease (inverse):
12 workers × 20 days = 15 workers × x days
240 = 15x → x = 240 ÷ 15 = **16 days**
...
1. Mixing units before forming ratios (convert all to same unit first)
2. Forgetting to add ratio parts when sharing quantities
3. Confusing direct with inverse proportion
4. In scale problems, forgetting that scale is a ratio of lengths, not areas
5. For compound ratios, dividing the total by the wrong number of parts

**Problem-Solving Strategy:**
1. Determine whether the problem involves sharing, direct proportion, or inverse proportion
2. For sharing: find one part, then multiply
3. For direct proportion: set up equation a₁/a₂ = b₁/b₂ or use unitary method
4. For inverse proportion: set up equation a₁ × b₁ = a₂ × b₂
5. Always check that your answer is sensible within the problem context
...
Point P divides AB in the ratio m:n. If A is at (x₁, y₁) and B is at (x₂, y₂), coordinates of P are:
P = ((mx₂ + nx₁)/(m+n), (my₂ + ny₁)/(m+n))

For example, P divides AB in ratio 2:3 where A(2,3) and B(8,9):
P = ((2×8 + 3×2)/(2+3), (2×9 + 3×3)/(2+3))
P = ((16+6)/5, (18+9)/5) = (22/5, 27/5) = **(4.4, 5.4)**
...
If a car travels 360 km in 4 hours, its average speed is:
360 km ÷ 4 hours = **90 km/h**

Converting between rates: to convert 72 km/h to m/s:
72 km/h × (1000 m/km) ÷ (3600 s/h) = 72,000 ÷ 3,600 = **20 m/s**
...
Let original wine = 5x litres and water = 3x litres.
After adding 10L water: (5x)/(3x+10) = 5/4
Cross-multiplying: 20x = 15x + 50 → 5x = 50 → x = 10
Original: Wine = 50L, Water = 30L

**Proving Direct and Inverse Variation**

To prove y varies directly as x: show that y/x = constant
To prove y varies inversely as x: show that xy = constant
...
1. Sharing money or goods in given ratios (Objective)
2. Rate problems involving speed, time, and distance (Theory)
3. Map scale calculations (Objective and Theory)
4. Mixture problems involving ratios (Theory)
5. Problems involving direct and inverse variation (Theory)
