...
1. **Self-sufficiency in growth signals** — cancer cells produce their own growth signals (autocrine signaling)
2. **Insensitivity to growth inhibitory signals** — loss of tumor suppressors (RB, p53)
3. **Evasion of apoptosis** — loss of p53, Bcl-2 overexpression
4. **Limitless replicative potential** — telomerase activation
5. **Sustained angiogenesis** — VEGF, FGF secretion
...
2. Intravasation (entry into lymphatics or blood vessels)
3. Survival in circulation (immune evasion — CTCs)
4. Extravasation at distant site
5. Colonization (seed and soil hypothesis — some organs more receptive)
