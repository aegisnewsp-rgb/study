...
topic: chemis-008
topicName: "Oxidation & Reduction Reactions"
weight: 3
country: uganda
...
**Oxidation & Reduction Reactions** — Key Facts for Makerere University (Uganda)
Core concept: Oxidation involves loss of electrons (or gain of oxygen/loss of hydrogen); reduction involves gain of electrons (or loss of oxygen/gain of hydrogen). In organic chemistry, these terms are applied to changes in oxidation state of carbon
High-yield points: Oxidizing and reducing agents in organic chemistry; oxidation of alcohols (1°, 2°, 3°); reduction of carbonyls; oxidation states of carbon; redox reactions in organic synthesis
⚡ Exam tip: Remember that oxidation of carbon increases its number of bonds to oxygen or decreases bonds to hydrogen; reduction does the opposite
...
**Oxidation & Reduction Reactions** — Makerere University (Uganda) Study Guide
...
**Rules:**
1. Each bond to H or metal (less electronegative than C) = **−1**
2. Each bond to C, N, S, halogens = **0** (equal electronegativity)
3. Each bond to O or halogen (more electronegative than C) = **+1**
4. Each bond to N with higher electronegativity contribution considered similarly
...
### Oxidizing Agents
1. **Acidified potassium dichromate (K₂Cr₂O₇/H₂SO₄)**: Orange Cr(VI) → Green Cr(III)
2. **Acidified potassium permanganate (KMnO₄/H₂SO₄)**: Purple → Brown MnO₂
3. **Tollens' reagent** (Ag(NH₃)₂⁺): For aldehydes only
4. **Pyridinium chlorochromate (PCC)**: Mild oxidant, stops at aldehyde for 1° alcohols
...
CH₃CH₂OH → (K₂Cr₂O₇/H⁺) → CH₃CHO → (further oxidation) → CH₃COOH
- Cr₂O₇²⁻ (orange) + 3e⁻ → 2Cr³⁺ (green) — color change indicates oxidation

**Secondary Alcohols (2°):**
2° alcohol → KETONE (no further oxidation under normal conditions)
...
**Example — Isopropanol oxidation:**
(CH₃)₂CHOH → (K₂Cr₂O₇/H⁺) → (CH₃)₂C=O (acetone) + H₂O

**Tertiary Alcohols (3°):**
3° alcohol → NO REACTION under mild oxidizing conditions
...
1. **Tollens' Reagent** (Ag(NH₃)₂⁺): Ag⁺ → Ag⁰ (silver mirror) — aldehydes only
2. **Fehling's Solution** (Cu²⁺/tartrate): Cu²⁺ → Cu₂O (red precipitate) — aldehydes only
3. **Benedict's Solution** (Cu²⁺/citrate): Similar to Fehling's
4. **Acidified KMnO₄** or **K₂Cr₂O₇**: Carboxylic acid
5. **Silver oxide (Ag₂O) with NaOH**: Carboxylic acid

### Tollens' Test
**Reaction:**
R–CHO + 2Ag(NH₃)₂⁺ + H₂O → R–COO⁻NH₄⁺ + 2Ag⁰ + 3NH₃ + NH₄⁺
(Silver mirror on test tube)

**Positive test**: Aldehydes ONLY (form silver mirror)
**Negative test**: Ketones, alcohols, alkanes (no silver mirror)
...
### Fehling's Test
**Reaction:**
R–CHO + 2Cu²⁺ + 2H₂O → R–COO⁻ + Cu₂O (brick-red precipitate) + 4H⁺
**Positive test**: Aldehydes (form red Cu₂O precipitate)
**Negative test**: Ketones (except α-hydroxy ketones)
...
**Example**: CH₃–CH=CH–CH₃ + hot KMnO₄ → 2CH₃COOH (acetic acid)
**Example**: CH₂=CH–CH₂–CH₃ + hot KMnO₄ → CO₂ + CH₃CH₂COOH (propionic acid)
...
### Reducing Agents
1. **NaBH₄ (Sodium borohydride)**: Mild; reduces aldehydes and ketones to alcohols; does NOT reduce esters, carboxylic acids, or amides
2. **LiAlH₄ (Lithium aluminium hydride)**: Strong; reduces aldehydes, ketones, esters, carboxylic acids, amides; requires dry conditions (reacts violently with water)
3. **H₂/Ni, Pt, or Pd**: Catalytic hydrogenation; reduces C=C and C=O; aromatic rings NOT reduced under mild conditions
4. **Sn/HCl or Fe/HCl**: Reduces nitro groups to amines (in aniline synthesis)
5. **Hydrazine (N₂H₄) + KOH**: Wolff-Kishner reduction (reduces C=O to CH₂)

### Reduction Products by Carbonyl Type

**Aldehydes → Primary Alcohols:**
R–CHO + NaBH₄ → R–CH₂OH
Example: Acetaldehyde → ethanol

**Ketones → Secondary Alcohols:**
R–CO–R' + NaBH₄ → R–CH(OH)–R'
Example: Acetone → isopropanol

**Esters → Two Alcohols (requires LiAlH₄):**
R–COOR' + 2[H] → R–CH₂OH + R'OH
Example: Ethyl acetate → ethanol + acetic acid (reduced to ethanol)

**Carboxylic Acids → Primary Alcohols (requires LiAlH₄):**
...
Aldehyde → (reduction) → alcohol (1°)
```

### Redox in Terms of Oxidation State Change
...
**Reagents:**
1. Sn/HCl or SnCl₂/HCl (classical method)
2. Fe/HCl (industrial)
3. H₂/Pd or H₂/Pt (catalytic hydrogenation)
4. Zn/NH₄Cl (reduction with metal in neutral conditions — for acid-sensitive compounds)

**TNT (2,4,6-trinitrotoluene)** can be reduced to **TNA (2,4,6-triamino-1-methylbenzene)**.

### Reduction in Different Media
**Acidic conditions**: R–NO₂ → R–NH₃⁺ → R–NH₂
**Neutral conditions**: Zn/NH₄Cl → R–NHOH → R–NH₂
**Basic conditions**: Zn/NaOH → azoxy compounds → azo → hydrazine compounds
...
1. "By what oxidation state change does [alcohol] become [aldehyde/carboxylic acid]?"
2. "Using [oxidizing agent], what product(s) are formed from [substrate]?"
3. "Explain how you would distinguish between [compound A] and [compound B] using chemical tests"
4. "In the oxidation of [compound] with [agent], what is the role of the oxidizing agent?"
5. "When [alkene] is treated with hot KMnO₄, what products are formed?"
6. "Calculate the oxidation state of carbon in [compound]"
...
**Example**: Oxidation of ethanol by dichromate:
CH₃CH₂OH → CH₃COOH (C: −2 to +2, change = 4 electrons lost)
Cr₂O₇²⁻ → Cr³⁺ (Cr: +6 to +3, change = 3 electrons gained per Cr)
Multiply ethanol half-reaction by 3 and dichromate by 4 to balance electrons:
3CH₃CH₂OH + 4Cr₂O₇²⁻ → 3CH₃COOH + 8Cr³⁺ + 11H₂O (balanced with H⁺ and H₂O)
...
**Q1**: Calculate the oxidation state of carbon in:
(a) CCl₄ (b) CH₃Br (c) CH₃OCH₃ (d) CO (e) C₂H₄
...
**Q3**: Describe chemical tests to distinguish between:
(a) Propan-1-ol and propan-2-ol
(b) Propanal and propanone
(c) Ethanol and ethanoic acid
(d) Benzoic acid and phenol

**Q4**: Write equations showing the oxidation of:
(a) Propan-1-ol to propanoic acid
(b) Cyclohexanol to cyclohexanone
(c) 2-methylpropan-1-ol to 2-methylpropanoic acid
...
1. **Confusing oxidation and reduction**: Oxidation = LEO (Loss of Electrons); Reduction = GER (Gain of Electrons). OR: Oxidation = more bonds to O (or fewer bonds to H); Reduction = fewer bonds to O (or more bonds to H).
2. **Forgetting that Tollens' and Fehling's are for aldehydes only**: Ketones don't react (with rare exceptions).
3. **Thinking hot KMnO₄ oxidation of alkenes gives diols**: No — hot concentrated gives cleavage products; cold dilute gives diols.
4. **Confusing NaBH₄ and LiAlH₄ capabilities**: NaBH₄ is milder and doesn't reduce carboxylic acids or esters; LiAlH₄ is stronger and does.
5. **Forgetting that oxidation of 1° alcohol to aldehyde is a 6-electron change**: 1° alcohol (C=−2) → aldehyde (C=+1) = 3-electron change per carbon; but you need to consider the full half-reaction.
