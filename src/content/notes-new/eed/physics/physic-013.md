...
Core concept: Topic 13 is an important topic in ('physics', 'Physics') for EGE (Russia)
...
Overview: Topic 13 is a key ('physics', 'Physics') topic for EGE (Russia)
...
Full coverage: Topic 13 in ('physics', 'Physics') for EGE (Russia) preparation
