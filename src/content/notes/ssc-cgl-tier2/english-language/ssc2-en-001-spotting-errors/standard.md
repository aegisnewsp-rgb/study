...
topic: ssc2-en-001-spotting-errors
topicName: Spotting Errors (Grammar)
tier: standard
weight: 2
weight_unit: "% of Tier 2 paper"
diagramPrompt: "A decision tree for error spotting: Start -> Check Subject-Verb Agreement -> Check Tense/Verb Form -> Check Articles -> Check Prepositions -> Check Pronouns -> Check Parallel Structure -> No Error"
country: India
generated: ai-v1
---
