...
| Pyramid type | Shape in terrestrial | Shape in aquatic |
|---|---|---|
| Number | Upright (sometimes inverted) | Generally inverted |
...
**Primary succession** starts on a bare area (lava, rock); **secondary succession** follows disturbance where soil persists (e.g., after fire). The sequence moves from **pioneer community** → **seral stages** → **climax community** (relatively stable).
