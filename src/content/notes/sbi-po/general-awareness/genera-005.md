...
**HDI Calculation**:
Each dimension is normalized to a 0-1 scale, then averaged:
...
1. **Disguised Unemployment**: More people employed than needed; common in agriculture
2. **Seasonal Unemployment**: No work available during off-season (agriculture)
3. **Structural Unemployment**: Mismatch between skills and available jobs; due to technological change
4. **Frictional Unemployment**: Between jobs; temporary; always present
5. **Cyclical Unemployment**: Due to economic downturn/recession
