...
> Rapid summary for last-minute revision before your INI CET seat.
...
> Standard content for building clinical pharmacology reasoning before the exam.

#### Seriousness Criteria vs Severity
...
> Comprehensive coverage for candidates targeting top ranks and integrated clinical questions.
...
1. Treating **ADR** and **AE** as synonyms — AEs without causal link do not qualify as ADRs.
2. Misreading Naranjo score boundaries (≥9 vs 5–8 vs 1–4).
3. Assigning **idiosyncratic Type B** reactions as preventable.
4. Forgetting that **PSURs** (not PSUR-like documents alone) and **RMPs (Risk Management Plans)** are mandated under NDCTR 2019 for new drugs.

#### Practice Prompts
1. A score of **7** on the Naranjo algorithm places the ADR in which category, and what is the next recommended step before labelling it "definite"?
2. A manufacturer receives a single report of fatal hepatotoxicity with a recently approved oral anticoagulant 22 days after marketing. Under NDCTR 2019, is this reportable as expedited, and by when?

## Continue your study

- **[View this topic in your INI CET (AIIMS PG) roadmap](/roadmap/?exam=ini-cet&duration=1mo)** — see where "Topic 10" fits in your personalised plan
