...
Core concept: Topic 1 is an important topic in ('physics', 'Physics') for COMEDK
...
Overview: Topic 1 is a key ('physics', 'Physics') topic for COMEDK
...
Full coverage: Topic 1 in ('physics', 'Physics') for COMEDK preparation
