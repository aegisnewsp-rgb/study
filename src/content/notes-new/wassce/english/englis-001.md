...
Core concept: Topic 1 is an important topic in ('english', 'English') for WASSCE (Ghana)
...
Overview: Topic 1 is a key ('english', 'English') topic for WASSCE (Ghana)
...
Full coverage: Topic 1 in ('english', 'English') for WASSCE (Ghana) preparation
