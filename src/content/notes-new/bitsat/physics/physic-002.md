...
Core concept: Topic 2 is an important topic in ('physics', 'Physics') for BITSAT
...
Overview: Topic 2 is a key ('physics', 'Physics') topic for BITSAT
...
Full coverage: Topic 2 in ('physics', 'Physics') for BITSAT preparation
