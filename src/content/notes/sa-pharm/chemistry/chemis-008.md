...
**Step 1**: Nucleophile attacks the electrophilic carbonyl carbon → forms a tetrahedral alkoxide intermediate
**Step 2**: The alkoxide (negatively charged oxygen) is protonated → gives the addition product
...
**Aldehyde/Ketone + Alcohol (1 equivalent)** → **Hemiacetal** (unstable, equilibrium)
**Aldehyde/Ketone + Alcohol (excess + acid catalyst)** → **Acetal** (stable)
...
**Enolization:**
In acidic or basic conditions, aldehydes and ketones can tautomerize to enols:
- Keto form ↔ Enol form
