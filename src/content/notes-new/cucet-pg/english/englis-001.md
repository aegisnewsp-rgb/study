...
Core concept: Topic 1 is an important topic in ('english', 'English') for CUCET (PG)
...
Overview: Topic 1 is a key ('english', 'English') topic for CUCET (PG)
...
Full coverage: Topic 1 in ('english', 'English') for CUCET (PG) preparation
