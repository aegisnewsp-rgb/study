...
topic: wassce-012
topicName: "Topic 12: Trigonometry"
weight: 3
country: ghana
...
A ladder 10 metres long leans against a wall making an angle of 65° with the ground. Find:
(a) How far the foot of the ladder is from the wall
(b) How high up the wall the ladder reaches

(a) Adjacent to angle = cos 65° = adjacent/10
Adjacent = 10 × cos 65° = 10 × 0.4226 = **4.23 m**

(b) Opposite to angle = sin 65° = opposite/10
Opposite = 10 × sin 65° = 10 × 0.9063 = **9.06 m**
...
tan 35° = height/40
height = 40 × tan 35° = 40 × 0.7002 = **28.0 m**

**Trigonometric Identities**

Prove that (sin θ + cos θ)² = 1 + 2 sin θ cos θ

LHS = sin²θ + 2 sin θ cos θ + cos²θ
...
b/sin 65° = 8/sin 40°
b = 8 × sin 65°/sin 40°
b = 8 × 0.9063/0.6428 = **11.3 cm**

**The Cosine Rule**

For triangle ABC: a² = b² + c² - 2bc cos A

Find angle A if a = 7, b = 5, c = 6.
...
1. Using the wrong trigonometric ratio (SOHCAHTOA confusion)
2. Confusing which side is opposite, adjacent, or the hypotenuse
3. Using degrees instead of radians or vice versa when required
4. Forgetting that sin, cos, and tan values can be greater than 1 (only sin and cos are bounded by -1 and 1)
5. Mixing up angle of elevation and angle of depression

**Problem-Solving Strategy:**
1. Draw a clear, labelled diagram
2. Identify the right angle and label the triangle
3. Determine which sides are known and which is required
4. Select the appropriate trigonometric ratio
5. Form an equation and solve
6. Check that your answer is sensible in the context of the problem
...
180° = π radians, so 1 radian ≈ 57.3°
...
For triangle with sides 7 cm and 10 cm, and included angle 55°:
Area = ½ × 7 × 10 × sin 55° = 35 × 0.8192 = **28.67 cm²**
...
1. Finding sides using SOHCAHTOA (Objective)
2. Finding angles using inverse trigonometric functions (Objective)
3. Angles of elevation and depression problems (Theory)
4. Sine rule and cosine rule applications (Theory)
5. Trigonometric identities (Theory)
