...
Core concept: Topic 2 is an important topic in ('physics', 'Physics') for UPSEE
...
Overview: Topic 2 is a key ('physics', 'Physics') topic for UPSEE
...
Full coverage: Topic 2 in ('physics', 'Physics') for UPSEE preparation
