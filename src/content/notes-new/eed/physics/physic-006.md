...
Core concept: Topic 6 is an important topic in ('physics', 'Physics') for EGE (Russia)
...
Overview: Topic 6 is a key ('physics', 'Physics') topic for EGE (Russia)
...
Full coverage: Topic 6 in ('physics', 'Physics') for EGE (Russia) preparation
