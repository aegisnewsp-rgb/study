...
topic: chemis-008
topicName: "Carboxylic Acids and Their Derivatives"
weight: 3
country: uae
...
Carboxylic acids react with alcohols under acidic catalysis (H₂SO₄) to form **esters**:
...
Carboxylic acids are very difficult to reduce. They are not reduced by NaBH₄ (which reduces aldehydes and ketones). Only **LiAlH₄ (LAH)** — a powerful reducing agent used in dry ether — can reduce carboxylic acids to **primary alcohols**:
...
Heating the sodium salt of a carboxylic acid with soda lime (NaOH + CaO) causes decarboxylation (loss of CO₂) to form an alkane with one fewer carbon:
R–COONa + NaOH →(soda lime, heat) R–H + Na₂CO₃
...
1. **Acid chlorides (R–COCl)** — suffix: -oyl chloride
2. **Acid anhydrides (R–CO–O–CO–R)** — suffix: anhydride
3. **Esters (R–COOR')** — suffix: -oate
4. **Amides (R–CONH₂, R–CONHR', R–CONR₂)** — suffix: -amide

### Relative Reactivity

The reactivity of acid derivatives toward nucleophiles follows the order:
...
Prepared by reacting carboxylic acids with thionyl chloride (SOCl₂), oxalyl chloride (COCl)₂, or phosphorus trichloride (PCl₃):
R–COOH + SOCl₂ → R–COCl + SO₂↑ + HCl↑

Acid chlorides are the **most reactive** carboxylic acid derivatives. They react violently with water (hydrolysis) to give the carboxylic acid:
...
Prepared by reacting acid chlorides with carboxylate salts:
R–COCl + R'–COONa → (R–CO)₂O + NaCl
...
Esters are formed from carboxylic acids + alcohols (Fischer esterification) or from acid chlorides + alcohols:
...
**Saponification:** Esters react with **aqueous NaOH** (or KOH) to give a carboxylate salt and an alcohol — this is the hydrolysis of esters in basic conditions:
...
Amides are formed from acid chlorides/anhydrides + amines, or from carboxylic acids + amines with a dehydrating agent (DCC or SOCl₂ followed by amine):
R–COOH + R'₂NH →(DCC) R–CONR'₂ + H₂O
