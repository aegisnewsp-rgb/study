...
**Core Operations Trade-offs:**
Every operations decision involves trade-offs. The key tensions XAT tests are:
...
When evaluating options in an operations case-let, ask:
