...
const exam: ExamTemplate = {
  ...
  examPattern: `AILET typically consists of 150 multiple-choice questions to be answered in 90 minutes. The paper is divided into sections: English (approximately 35 questions) testing grammar, vocabulary, and comprehension; Legal Reasoning (approximately 35 questions) covering legal aptitude and legal GK; Logical Reasoning (approximately 35 questions); General Knowledge (approximately 35 questions) including current affairs and static GK; and Elementary Mathematics (approximately 10 questions). Each correct answer typically carries 1 mark, with 0.25 marks deducted for each incorrect answer. The examination is conducted in offline (pen-and-paper) mode.`,
  eligibility: `Candidates must have completed their 10+2 or equivalent examination with a minimum of 50% aggregate marks (45% for SC/ST/PwD candidates) from a recognized board. There is no upper age limit for the undergraduate programme as per the latest guidelines. Foreign nationals are also eligible to apply but must meet the equivalence requirements set by the Association of Indian Universities (AIU). As notified by NLU Delhi (https://nludelhi.ac.in), candidates for the LLM programme must hold an LLB degree with at least 55% aggregate marks (50% for SC/ST/PwD).`,
  subjects,
    durations: {
