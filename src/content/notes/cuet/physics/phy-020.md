...
**AC Generator:**
Principle: A rectangular coil rotating in a uniform magnetic field. The emf induced: $\varepsilon = \varepsilon_0 \sin(\omega t)$ where $\varepsilon_0 = NBA\omega$ is the peak emf. $N$ = number of turns, $B$ = magnetic field strength, $A$ = area of coil, $\omega$ = angular velocity.
