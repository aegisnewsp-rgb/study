...
Core concept: Topic 1 is an important topic in ('physics', 'Physics') for WBJEE
...
Overview: Topic 1 is a key ('physics', 'Physics') topic for WBJEE
...
Full coverage: Topic 1 in ('physics', 'Physics') for WBJEE preparation
