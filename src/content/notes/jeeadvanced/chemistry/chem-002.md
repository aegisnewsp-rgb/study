...
weight: 5
country: india
generated: "2026-03-24T08:32:07.921493"
...
| n | 1, 2, 3... | Shell | Azimuthal l = 0 to n−1 |
| m | −l to +l | Orbital orientation | Magnetic spin ms = ±½ |
| Spin (s) | +½, −½ | Paired in orbitals | Hund's rule: max multiplicity |
...
How many electrons in Fe (Z = 26) can have n = 3, l = 2 simultaneously?
n = 3, l = 2 means 3d subshell. For d: l = 2, so mₗ = −2, −1, 0, +1, +2 (5 orbitals). Each holds 2 electrons with opposite spin = 10 electrons total.
...
- **Ionization Energy (IE)**: Energy to remove the most loosely held electron. General trend: increases across a period (excluding IE dips at B, Al, Ga and noble gas peak). First IE decreases down a group (atomic size increases).
  ΔH = IE (always endothermic, positive).
...
l = 0, 1, 2, ..., n−1
mₗ = −l, ..., 0, ..., +l
mₛ = +½ or −½ (Dirac's relativistic equation later refined this)
...
**Slater's Rules (detailed):**
For 1s electron: each other electron in 1s = 0.30
For ns, np electron:
...
IE₁(N) > IE₁(O) — though both are in period 2, O has lower IE because removing an electron breaks the half-filled 2p subshell stability of N.
