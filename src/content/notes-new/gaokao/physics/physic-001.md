...
Core concept: Topic 1 is an important topic in ('physics', 'Physics') for Gaokao (China)
...
Overview: Topic 1 is a key ('physics', 'Physics') topic for Gaokao (China)
...
Full coverage: Topic 1 in ('physics', 'Physics') for Gaokao (China) preparation
