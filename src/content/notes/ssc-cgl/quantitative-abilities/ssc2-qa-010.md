...
topic: ssc2-qa-010
topicName: "Mensuration (2D + 3D with numericals)"
tier: unified
weight: 2
...
### Key Rule / Formula
2D: Square: area = a², perimeter = 4a. Rectangle: area = l×b, perimeter = 2(l+b). Circle: area = πr², circumference = 2πr. Triangle: area = ½×b×h.
3D: Cube: volume = a³, TSA = 6a². Cylinder: volume = πr²h, CSA = 2πrh. Sphere: volume = (4/3)πr³, TSA = 4πr².
...
A: Volume = (22/7) × 7² × 10 = 22 × 7 × 10 = **1540 cm³**.
