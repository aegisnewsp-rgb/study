...
**Two Variables (Substitution/Elimination)**:
```
...
⚡ **GAT PYQ**: "If 3x + 4y = 10 and 2x - y = 3, find x + y" → Answer: 3
...
**Remainder Theorem**:
If polynomial f(x) is divided by (x - a), remainder = f(a)
...
a = 2, r = 3, n = 4
Sₙ = 2(3^4 - 1)/(3-1) = 2(81 - 1)/2 = 80
```

**Harmonic Progression (HP)**:
Terms are reciprocals of AP terms.
...
⚡ **GAT Strategy**: For algebraic identities, memorize the squares (up to 30²) and cubes (up to 15³) to speed up calculations.
...
= log(27)/log(9) = log(3³)/log(3²) = 3log(3)/2log(3) = 3/2
```
