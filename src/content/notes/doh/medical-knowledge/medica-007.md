...
| End-organ damage | No | Yes (encephalopathy, MI, stroke, renal failure, eclampsia) |
| Treatment | Gradual reduction over 24–48h | Immediate reduction in ICU with IV antihypertensives |
| Hospital admission | Optional | Mandatory |
...
| Feature | Stable Angina | ACS (Unstable Angina + NSTEMI + STEMI) |
|---|---|---|
| Trigger | Predictable (exertion, emotion) | Unpredictable; at rest |
| Duration | < 10 minutes | > 10 minutes; new onset; crescendo |
| Relief | Rest or nitrates | May NOT relieve with rest/nitrates |
| Pathology | Fixed atherosclerotic stenosis | Plaque rupture → thrombosis |
...
- **F**ace: Facial droop, asymmetry
- **A**rms: Arm drift, weakness
- **S**peech: Slurred, aphasic, mute
- **T**ime: Call immediately — TIME IS BRAIN
