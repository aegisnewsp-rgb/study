...
$$P: \text{Tall (TT)} \times \text{Short (tt)}$$
$$F_1: \text{All Tall (Tt)}$$
$$F_2: \genfrac{}{}{0pt}{}{\text{T}}{\text{T}} \genfrac{}{}{0pt}{}{}{} \Rightarrow 3 \text{ Tall} : 1 \text{ Short}$$
...
When a population is not evolving, allele and genotype frequencies remain constant:
$$p^2 + 2pq + q^2 = 1$$
$$p + q = 1$$
