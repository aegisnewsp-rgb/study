...
⚡ **BPSC PYQ**: "Explain the theory of plate tectonics with suitable examples"
Answer: Earth's lithosphere is divided into plates that move due to convection currents in the asthenosphere. At divergent boundaries, seafloor spreading occurs; at convergent boundaries, subduction or collision creates mountains and trenches; at transform boundaries, plates slide past each other causing earthquakes.
