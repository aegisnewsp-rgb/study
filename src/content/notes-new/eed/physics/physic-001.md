...
Core concept: Topic 1 is an important topic in ('physics', 'Physics') for EGE (Russia)
...
Overview: Topic 1 is a key ('physics', 'Physics') topic for EGE (Russia)
...
Full coverage: Topic 1 in ('physics', 'Physics') for EGE (Russia) preparation
