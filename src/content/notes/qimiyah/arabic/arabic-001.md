...
subjectName: Arabic
topic: arabic-001
topicName: "Arabic Alphabet and Vocalization (Harakat)"
weight: 3
country: saudi
...
1. **FatHa (فتحة)** — a small diagonal stroke above a letter → sounds like "a" as in "cat"
   - Symbol: فتحة
   - Example: بَ (ba)

2. **Kasra (كسرة)** — a small diagonal stroke below a letter → sounds like "i" as in "bit"
   - Symbol: كسرة
   - Example: بِ (bi)

3. **Damma (ضمة)** — a small curl above a letter → sounds like "u" as in "put"
   - Symbol: ضمة
   - Example: بُ (bu)
...
1. **On Alif (ء)**: Only when the hamza is the first letter of a word and carries fatḥa or sukūn
2. **On Waw (ؤ)**: When the hamza carries ḍamma
3. **On Ya (ئ)**: When the hamza carries kasra
