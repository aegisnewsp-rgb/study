...
topic: genst-011
topicName: National Income Identities
weight: 3
country: india
...
- **Indian Economy** for UPPSC RO/ARO tests three layers: (a) **National Income Accounting** — **GDP = C + I + G + (X − M)**, with **GNP = GDP + NFIA**, and **NDP = GDP − Depreciation**. Base year for GDP is **2011–12**.
...
#### Price Indices & Inflation Mechanics
...
#### Practice Prompts
1. **Numerical**: If Nominal GDP = ₹250 lakh crore and GDP Deflator = 125, compute Real GDP and the inflation rate relative to last year when Real GDP was ₹180 lakh crore. *(Answer: Real GDP = ₹200 lakh crore; growth ≈ 11.1%)*
2. **Analytical**: "The 2018 FRBM amendment replaced the absolute fiscal deficit target with an 'escape clause' anchored to debt-to-GDP." Discuss whether this preserves or weakens India's fiscal credibility, citing **Primary Deficit**, **Revenue Deficit**, and **Effective Revenue Deficit** trends.
