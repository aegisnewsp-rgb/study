...
1. **Trust**: Financial system operates on trust — breach of ethics erodes public confidence
2. **Sustainability**: Ethical businesses survive longer and build reputation
3. **Legal Compliance**: Many ethics norms are now codified in law
4. **Employee Morale**: Ethical workplaces attract and retain talent
5. **Financial Performance**: Ethical companies often outperform in long run (ESG investing)
...
2. **Rights and Shareholder Protections**
