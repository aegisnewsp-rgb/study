...
**Example**: A ladder 13 m long leans against a wall, foot 5 m from wall. Height?
c = 13, a = 5; b² = 13² − 5² = 169 − 25 = 144; b = **12 m**
...
**Example**: Circle with radius 7 cm (π = 22/7).
Circumference = 2 × (22/7) × 7 = **44 cm**; Area = (22/7) × 49 = **154 cm²**
...
**Example**: Cylindrical tank: radius 3 m, height 7 m. Volume (π = 22/7)?
V = (22/7) × 3² × 7 = 22 × 9 = **198 m³**
...
**Congruent triangles**: Same shape AND same size (all corresponding sides and angles equal).
Tests: SSS, SAS, ASA, AAS, RHS (for right-angled triangles).
...
**Example**: A cone has base radius 3 cm and slant height 5 cm. Find its total surface area.
TSA = πr(r + l) = (22/7) × 3 × (3+5) = (22/7) × 24 = **528/7 ≈ 75.43 cm²**
...
**Example**: Find the area of a sector of radius 6 cm with angle 60°.
= (60/360) × π × 36 = (1/6) × 36π = **6π cm²**
...
**Example**: A square-based pyramid has base side 6 cm and height 4 cm.
Base area = 36 cm²; V = (1/3) × 36 × 4 = **48 cm³**

## Locus Problems
The locus of points equidistant from a fixed point is a **circle**.
The locus of points equidistant from two intersecting lines is the **bisectors** (angle bisector).
