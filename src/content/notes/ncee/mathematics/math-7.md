...
**Example:**
In a triangle, one angle is $50°$ and another is $60°$. Find the third angle.
$50 + 60 + x = 180$
$110 + x = 180$
$x = 70°$
...
**Example:**
If an exterior angle is $110°$ and one opposite interior angle is $45°$, find the other opposite interior angle.
$45° + x = 110°$
$x = 65°$
...
In a right-angled triangle with sides $a$, $b$ (legs) and $c$ (hypotenuse, opposite the right angle):
$$a^2 + b^2 = c^2$$
...
For any triangle with sides $a$, $b$, $c$ and semi-perimeter $s = (a+b+c)/2$ (Heron's formula):
$$Area = \sqrt{s(s-a)(s-b)(s-c)}$$

**Example:**
Triangle with sides 3, 4, 5 cm:
$s = (3+4+5)/2 = 6$
$Area = \sqrt{6(6-3)(6-4)(6-5)} = \sqrt{6 \times 3 \times 2 \times 1} = \sqrt{36} = 6$ cm²
(This is a right triangle with legs 3 and 4, so area = $1/2 \times 3 \times 4 = 6$ cm² ✓)
