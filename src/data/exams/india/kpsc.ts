...
const exam: ExamTemplate = {
  ...
  examPattern: `The KPSC KAS Preliminary Examination consists of two objective MCQ papers of 2 hours duration each: Paper I covers General Studies (national and international) and Humanities (100 questions, 200 marks); Paper II covers General Studies (state significance, science, technology, environment) and General Mental Ability (100 questions, 200 marks). Under the official Commission scheme, negative marking deducts typically 0.25 of the marks assigned to each question (0.50 mark deducted per incorrect answer). As notified by the Karnataka Public Service Commission (kpsc.kar.nic.in), the Main Examination comprises two qualifying language papers (Kannada and English, 150 marks each, typically with a 35% minimum passing threshold) and five compulsory scoring papers of 250 marks and 3 hours each: Essay, GS-I, GS-II, GS-III, and GS-IV (1250 marks total). The Personality Test carries 50 marks as notified in the official scheme, bringing the final merit aggregate to 1300 marks.`,
  eligibility: `Candidates must be Indian citizens holding a bachelor's degree from a recognized university. As notified in official Karnataka Public Service Commission (kpsc.kar.nic.in) gazetted notifications, the prescribed age limit is typically 21 to 38 years for General Merit (GM), 21 to 41 years for OBC categories (2A, 2B, 3A, 3B), and 21 to 43 years for SC, ST, and Category-1, subject to cycle-specific government orders. Knowledge of Kannada is mandatory, verified either by schooling with Kannada as a language or by clearing KPSC's compulsory Kannada language test. Domicile or reservation certificates issued by competent Karnataka revenue authorities are required for category relaxations.`,
  subjects,
    durations: {
