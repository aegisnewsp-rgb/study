...
const exam: ExamTemplate = {
  ...
  eligibility: `Candidates must possess a minimum of five credit passes in WAEC WASSCE, NECO SSCE, or NABTEB examinations in not more than two sittings, including English Language and Mathematics alongside relevant teaching subject prerequisites. Candidates applying through the Joint Admissions and Matriculation Board (JAMB, jamb.gov.ng) must typically be at least 16 years of age by the admission cycle as notified in the official guidelines of the National Commission for Colleges of Education (NCCE, ncceonline.edu.ng).`,
  subjects,
    durations: {
