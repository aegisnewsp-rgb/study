...
| Manager | Leader |
|---------|--------|
| Adopts formal authority | Creates vision and inspiration |
| Does things right | Does the right things |
| Focuses on systems and structure | Focuses on people and culture |
...
Plots leadership style on Concern for People (Y-axis) vs Concern for Production (X-axis):
...
Four leadership styles based on Task Behavior and Relationship Behavior:
