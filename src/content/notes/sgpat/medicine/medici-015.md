...
1. Reporting MPR and PDC as interchangeable when PDC is the Saudi MoH-preferred quality metric and is capped at 100%.
2. Treating a single MMAS-8 score as diagnostic — the scale is a screening adjunct, not a confirmation tool.
3. Failing to document a structured care plan with measurable review dates, which exposes the GP to medico-legal risk.
4. Ignoring polypharmacy in patients ≥65 years, where Beers Criteria and STOPP/START tools apply.
5. Relying solely on patient-reported adherence without objective refill or biochemical verification.
...
1. Calculate PDC for a patient who refilled 120 days of atorvastatin during a 150-day period and justify whether ≥80% adherence is met.
2. Outline the components of a Saudi MoH-aligned chronic care plan for a newly diagnosed diabetic, including SMART goals and review interval.

## Continue your study

- **[View this topic in your Saudi GP Board roadmap](/roadmap/?exam=sgpat&duration=1mo)** — see where "Topic 15" fits in your personalised plan
