...
Core concept: Topic 3 is an important topic in ('english', 'English') for KUCCPS (Kenya)
...
Overview: Topic 3 is a key ('english', 'English') topic for KUCCPS (Kenya)
...
Full coverage: Topic 3 in ('english', 'English') for KUCCPS (Kenya) preparation
