...
Core concept: Topic 12 is an important topic in ('physics', 'Physics') for EGE (Russia)
...
Overview: Topic 12 is a key ('physics', 'Physics') topic for EGE (Russia)
...
Full coverage: Topic 12 in ('physics', 'Physics') for EGE (Russia) preparation
