...
topic: chemis-007
topicName: Electronic Configuration and Periodicity
weight: 3
country: uganda
...
|----------|-------------------|--------|
| Hydroxides, M(OH)₂ | Solubility **increases** | Decreasing lattice energy dominates |
| Sulphates, MSO₄ | Solubility **decreases** | Hydration enthalpy falls faster than lattice energy |
...
Ammonia is recycled, so the net stoichiometry simplifies to:
