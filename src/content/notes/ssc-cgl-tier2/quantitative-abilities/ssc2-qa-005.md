...
diagramPrompt: "A timeline showing partner contributions over 12 months with segmented bars for each partner's capital changes, with the final profit distribution waterfall at the bottom."
country: India
generated: ai-v1
---
...
### Key Rule / Formula
Ratio a:b = a/b. If a:b = c:d, then a×d = b×c (cross-multiplication).
Partnership profit/loss divided in ratio of **capital × time** invested.
...
Q: Divide 144 in the ratio 3:4:5.
A: Sum of parts = 3+4+5 = 12. Each part = 144/12 = 12.
→ Parts = 3×12 = **36**, 4×12 = **48**, 5×12 = **60**
...
**Mean proportional:** Mean proportional between a and b = √(a×b)

### Partnership — Capital × Time

**Principle:** Profit (or loss) is shared in the ratio of each partner's **effective contribution**
Effective contribution = Capital invested × Time period

**Step-by-step example:**
A puts ₹5,000 for 12 months; B puts ₹3,000 for 8 months
A's contribution = 5000 × 12 = 60,000
B's contribution = 3000 × 8 = 24,000
Ratio = 60000 : 24000 = **5 : 2**
Total profit = ₹14,000 → A gets (5/7) × 14000 = **₹10,000**, B gets (2/7) × 14000 = **₹4,000**
...
### Worked Example
**Q:** A and B invest ₹3,000 and ₹5,000 respectively in a business. After 8 months, A adds ₹2,000 more and B withdraws ₹1,000. If the profit after a year is ₹22,000, find A's share.
**Approach:** A: 3000 × 8 + 5000 × 4 = 24000 + 20000 = 44000. B: 5000 × 8 + 4000 × 4 = 40000 + 16000 = 56000. Ratio = 44000:56000 = 11:14. A's share = 11/(11+14) × 22000 = 11/25 × 22000 = ₹9,680.
**Answer:** ₹9,680
