...
1. A sound wave of frequency 440 Hz travels through air at 352 m/s. Find its wavelength and the new wavelength when it enters water where speed rises to 1480 m/s. (Answer: 0.80 m in air; frequency stays 440 Hz, wavelength becomes 3.36 m.)
2. A ray hits a water–air boundary from inside water (n = 1.33) at 50°. Does it refract or undergo total internal reflection? (Answer: sin θc = 1/1.33 = 0.752, θc ≈ 48.8°, so 50° > θc — total internal reflection occurs.)

---

## Continue your study

- **[View this topic in your UAE University CAT roadmap](/roadmap/?exam=uaeu-cat&duration=1mo)** — see where "Topic 9" fits in your personalised plan
