...
topic: genera-005
topicName: Pakistan's Foreign Policy and International Relations
weight: 3
country: pakistan
...
**Guiding Principles**:
1. **Kashmir as the core issue**: All relations with India mediated through Kashmir dispute
2. **Strategic alliance with USA**: Counter-Soviet influence → Cold War legacy
3. **Strategic partnership with China**: "Iron brother" — CPEC, diplomatic support
4. **Islamic Ummah**: Support for Palestinian cause, ties with Muslim world
5. **Afghanistan stabilization**: Cross-border instability, Afghan peace process
6. **Economic diplomacy**: Trade promotion, attracting investment (CPEC)
