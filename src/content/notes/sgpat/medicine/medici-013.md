...
| SOAP Section | Content Type | Common Error |
|---|---|---|
| Subjective | Patient's own words, HPI, ROS | Recording "no chest pain" under signs |
| Objective | Vital signs, exam, labs | Writing the patient's complaints here |
| Assessment | Prioritized differential | Listing one diagnosis only |
| Plan | Diagnostics, Rx, education, follow-up | Omitting follow-up timing |
...
- **[View this topic in your Saudi GP Board roadmap](/roadmap/?exam=sgpat&duration=1mo)** — see where "Topic 13" fits in your personalised plan
