...
Core concept: Topic 8 is an important topic in ('physics', 'Physics') for Gaokao (China)
...
Overview: Topic 8 is a key ('physics', 'Physics') topic for Gaokao (China)
...
Full coverage: Topic 8 in ('physics', 'Physics') for Gaokao (China) preparation
