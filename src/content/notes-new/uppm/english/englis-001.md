...
Core concept: Topic 1 is an important topic in ('english', 'English') for UPPM Medicine (Malaysia)
...
Overview: Topic 1 is a key ('english', 'English') topic for UPPM Medicine (Malaysia)
...
Full coverage: Topic 1 in ('english', 'English') for UPPM Medicine (Malaysia) preparation
