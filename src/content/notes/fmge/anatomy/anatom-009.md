...
| Feature | Male | Female |
|---|---|---|
| Overall shape | Narrower, deeper | Wider, shallower |
| Pelvic inlet | Heart-shaped | Oval |
| Pelvic outlet | Smaller | Larger |
| Subpubic angle | <90° (V-shaped) | >90° (U-shaped) |
| Sacrum | Longer, more curved | Shorter, flatter |
| Ischial tuberosities | Inward | Everted |
| Pre-auricular sulci | Shallow/absent | Deep in multiparous |
