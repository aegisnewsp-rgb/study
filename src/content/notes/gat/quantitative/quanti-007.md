...
⚡ **Common Mistake**: Never take simple average of two speeds unless time or distance is equal!

#### Relative Speed

**When moving in same direction**:
$$v_{rel} = v_1 - v_2 \text{ (if } v_1 > v_2\text{)}$$
...
Time = 200/20 = 10 hours
```

⚡ **GAT PYQ**: "Two trains 100 m and 150 m long are running at
40 km/h and 50 km/h in opposite directions. Time to cross each other?" → Answer: 12 seconds
...
**Formulas**:
$$B = \frac{v_{down} + v_{up}}{2}$$
$$S = \frac{v_{down} - v_{up}}{2}$$
...
Total time = 24/7 + 24/13 = (312 + 168)/91 = 480/91 ≈ 5.27 hours
```

⚡ **GAT PYQ**: "A boat goes 30 km downstream in 2 hours and the same
distance upstream in 3 hours. Find speed of boat in still water."
→ Answer: 12.5 km/h
...
5. A car goes from A to B at 60 km/h and returns at 40 km/h. Find
   ...
   Answer: (b) 48 km/h
   Solution: v_avg = (2 × 60 × 40)/(60+40) = 4800/100 = 48 km/h
```

⚡ **GAT Strategy**: For circular track problems, remember: circumference = 2πr. For same direction meetings, use relative speed = difference; for opposite direction, use sum.
...
Time = 100 / (25/18) = 100 × 18/25 = 72 seconds
```
