...
topic: audit-008
topicName: "Audit Reports & Communications"
weight: 3
country: accagl
...
Used to draw attention to a matter PRESENTED AND DISCLOSED in FS that is fundamental to users' understanding.
...
**Other Matter (OM):**
Used when auditor is unable to withdraw but OTHER matters exist that are relevant to users' understanding.
