...
Core concept: Topic 2 is an important topic in ('physics', 'Physics') for ECAT (Engineering)
...
Overview: Topic 2 is a key ('physics', 'Physics') topic for ECAT (Engineering)
...
Full coverage: Topic 2 in ('physics', 'Physics') for ECAT (Engineering) preparation
