...
- **SN2 Reaction**: Bimolecular nucleophilic substitution — backside attack, Walden inversion, concerted single step, rate = k[Nu⁻][Substrate]
...
Better leaving groups = better at SN2
Order: I⁻ > Br⁻ > Cl⁻ > F⁻
...
**Step 1 (Slow, RDS)**: The leaving group departs, forming a carbocation.
...
**Carbocation Stability (Most Important Factor):**
Order: **3° > 2° > 1° > Methyl**
