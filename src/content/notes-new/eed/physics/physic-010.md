...
Core concept: Topic 10 is an important topic in ('physics', 'Physics') for EGE (Russia)
...
Overview: Topic 10 is a key ('physics', 'Physics') topic for EGE (Russia)
...
Full coverage: Topic 10 in ('physics', 'Physics') for EGE (Russia) preparation
