...
| Property | Equation | Units of constant |
|---|---|---|
| Boiling-point elevation | ΔTb = Kb · m · i | Kb in °C·kg/mol |
| Freezing-point depression | ΔTf = Kf · m · i | Kf in °C·kg/mol |
| Osmotic pressure | π = i · M · R · T | R = 0.0821 L·atm/(mol·K) |
| Vapor-pressure lowering | ΔP = (1 − x_solvent) · P° | Raoult's law |
...
|---|---|---|
| Molarity (M) | mol solute / L solution | π equation |
| Molality (m) | mol solute / kg solvent | ΔTb, ΔTf |
| Mole fraction (x) | mol component / total mol | Raoult's law |
...
Step 1 — moles: 5.85 g ÷ 58.5 g/mol = 0.100 mol NaCl.
Step 2 — molarity: 0.100 mol ÷ 2.00 L = 0.0500 mol/L.
Step 3 — i for NaCl ≈ 2, T = 300 K.
Step 4 — π = iMRT = 2 × 0.0500 × 0.0821 × 300 = **2.463 atm**.
...
- **[View this topic in your UTBK/SNPMTN (Indonesia) roadmap](/roadmap/?exam=utbk&duration=1mo)** — see where "Topic 10" fits in your personalised plan
