...
Core concept: Topic 11 is an important topic in ('physics', 'Physics') for BITSAT
...
Overview: Topic 11 is a key ('physics', 'Physics') topic for BITSAT
...
Full coverage: Topic 11 in ('physics', 'Physics') for BITSAT preparation
