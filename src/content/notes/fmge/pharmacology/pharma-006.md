...
1. **Mesophyll cell:** Phosphoenolpyruvate (PEP) carboxylase (affinity for CO₂ 60× greater than Rubisco) fixes CO₂ → **oxaloacetate (OAA, 4C)** → converted to malate or aspartate.
2. **Bundle sheath cell:** 4-carbon acid is decarboxylated; CO₂ is concentrated and refixed by Rubisco through the standard Calvin cycle.
...
1. A C3 plant and a C4 plant are grown together under conditions of 40°C, high light, and 350 ppm CO₂. Predict which plant will show higher photosynthetic rate and explain the biochemical basis, including the roles of PEP carboxylase and Rubisco. What change in atmospheric CO₂ would reduce the advantage of the C4 plant?
