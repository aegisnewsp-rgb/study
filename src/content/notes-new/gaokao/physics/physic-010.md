...
Core concept: Topic 10 is an important topic in ('physics', 'Physics') for Gaokao (China)
...
Overview: Topic 10 is a key ('physics', 'Physics') topic for Gaokao (China)
...
Full coverage: Topic 10 in ('physics', 'Physics') for Gaokao (China) preparation
