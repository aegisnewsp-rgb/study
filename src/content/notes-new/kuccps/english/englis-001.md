...
Core concept: Topic 1 is an important topic in ('english', 'English') for KUCCPS (Kenya)
...
Overview: Topic 1 is a key ('english', 'English') topic for KUCCPS (Kenya)
...
Full coverage: Topic 1 in ('english', 'English') for KUCCPS (Kenya) preparation
