...
topic: decisi-004
topicName: Human Resource Decisions
weight: 3
country: india
...
**The FAIR Test for HR Decisions:**
When evaluating options in an HR case-let, apply the FAIR test:
- **F**airness — Is the decision equitable? Does it treat similar employees similarly?
