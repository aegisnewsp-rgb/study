...
**Ratio and Proportion** — Key Facts for NABE (Pakistan)
...
## Ratio and Proportion — NABE (Pakistan) Study Guide
...
**Formula**: a ∝ b → a = kb (where k is constant)
**Example**: If 5 books cost Rs. 250, what do 8 books cost?
...
**Formula**: a ∝ 1/b → ab = k (constant)
**Example**: If 12 workers complete a job in 20 days, how many days for 15 workers?
...
## Ratio and Proportion — Comprehensive NABE (Pakistan) Notes
...
**Dividing a Quantity in Given Ratio**:
If a sum S is divided in ratio a:b:c:
...
**Proportion in Mixtures**:
Alligation method for weighted averages:
