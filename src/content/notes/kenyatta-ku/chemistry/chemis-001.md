...
1. **Tetravalence**: Carbon has four valence electrons and forms four covalent bonds
2. **Catenation**: Carbon atoms bond to each other to form long chains, rings, and complex network structures
3. **Multiple bonding**: Carbon forms double (C=C) and triple (C≡C) bonds, greatly expanding possible structures
...
Occurs when one s orbital mixes with three p orbitals to form four equivalent sp³ hybrid orbitals, each at 109.5° to the others.
...
Occurs when one s orbital mixes with two p orbitals to form three sp² hybrid orbitals (120° apart) with one unhybridised p orbital perpendicular to the plane.
...
Occurs when one s orbital mixes with one p orbital to form two sp hybrid orbitals (180° apart) with two unhybridised p orbitals.
...
## Detailed Orbital Theory and Bonding in Organic Chemistry
...
1. Priority: Rank four substituents by atomic number (highest = 1)
2. Orientation: Place lowest priority group away from viewer
3. Trace: Trace from priority 1 → 2 → 3
...
4. Assemble the name: substituent positions + substituent names + parent chain name + principal group suffix
...
**Saturated hydrocarbons (Alkanes):** Contain only single bonds (C–C and C–H), formula CₙH₂ₙ₊₂
