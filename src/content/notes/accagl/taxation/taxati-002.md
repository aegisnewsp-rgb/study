...
**Income from Salary** — Key ACCA/CA Pakistan Facts

**Governing Section:** Section 12 of the Income Tax Ordinance, 2001 (ITO 2001). Salary is the **first head of income**.

**Definition of Salary (Section 11):**
Salary includes: **wages, profits, commission, fees, bonus, gratuity, perquisites, contributions to retirement benefits, and any amount credited or paid** — in cash or in kind.
...
**Income from Salary** — ACCA/CA Pakistan Study Guide
...
**Advance Salary:** Taxed in the year received, even if relating to future services.
**Arrears of Salary:** Taxed in the year received. Relief under Section 32 (smearing) may spread the tax burden — but only for tax calculation, not for determining the year of taxability.
...
**Income from Salary** — Comprehensive ACCA/CA Pakistan Notes
...
**Step-by-Step:**
1. **Gross Salary** = Basic + All allowances (cash) + Monetary value of perquisites
2. **Add:** Amounts treated as salary (arrears, bonus, gratuity if taxable)
3. **Less:** Exempt allowances/perquisites (identify specifically exempt items)
4. **Less:** Employee's PF contribution (deductible under Section 60)
5. **= Taxable Salary Income**
6. **Compute Tax** using the applicable slab rates
7. **Less:** Tax credit for PAYE withheld (tax paid by employer)
8. **= Net Tax Payable/Refundable**
