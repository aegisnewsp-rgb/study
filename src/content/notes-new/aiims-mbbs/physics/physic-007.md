...
Core concept: Topic 7 is an important topic in ('physics', 'Physics') for AIIMS MBBS
...
Overview: Topic 7 is a key ('physics', 'Physics') topic for AIIMS MBBS
...
Full coverage: Topic 7 in ('physics', 'Physics') for AIIMS MBBS preparation
