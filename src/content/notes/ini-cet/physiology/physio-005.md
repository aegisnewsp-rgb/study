...
topic: physio-005
topicName: "Hemodynamics and Blood Pressure Regulation"
weight: 3
country: india
...
- **Renin-Angiotensin-Aldosterone System (RAAS)**:
  1. Renin (from juxtaglomerular cells — low perfusion pressure, ↓Na⁺ delivery, β₁ stimulation) converts Angiotensinogen → Angiotensin I
  2. ACE (lung endothelium) converts Ang I → **Angiotensin II** (active)
  3. Ang II: Potent vasoconstrictor; stimulates aldosterone (Na⁺/water retention); ADH release; thirst; sympathetic activation; cardiac remodeling
  4. Aldosterone: Distal tubule Na⁺ reabsorption + K⁺ secretion → ↑blood volume → ↑BP
