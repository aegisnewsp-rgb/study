...
Core concept: Topic 3 is an important topic in ('physics', 'Physics') for ECAT (Engineering)
...
Overview: Topic 3 is a key ('physics', 'Physics') topic for ECAT (Engineering)
...
Full coverage: Topic 3 in ('physics', 'Physics') for ECAT (Engineering) preparation
