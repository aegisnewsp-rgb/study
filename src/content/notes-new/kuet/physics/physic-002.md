...
Core concept: Topic 2 is an important topic in ('physics', 'Physics') for KUET
...
Overview: Topic 2 is a key ('physics', 'Physics') topic for KUET
...
Full coverage: Topic 2 in ('physics', 'Physics') for KUET preparation
