...
#### Present Simple
**Use**: Habits, facts, general truths, scheduled events
**Form**: S + V1(s/es for 3rd person singular)
...
#### Present Continuous
**Use**: Actions happening now, ongoing actions, temporary situations
...
#### Present Perfect
**Use**: Past actions with present relevance, experiences, completed actions with results
**Form**: S + have/has + V3 (past participle)
...
**Use**: Action that started in the past and continues to the present
...
#### Past Simple
**Use**: Completed past actions, sequences of past events
**Form**: S + V2 (past tense)
...
#### Past Continuous
**Use**: Action in progress at a specific past time, background actions
...
#### Past Perfect
**Use**: Action completed BEFORE another past action (earlier past)
**Form**: S + had + V3
...
**Use**: Continuous action that was interrupted or ended before another past action
...
#### Future Simple
**Use**: Decisions at the moment, predictions, promises, spontaneous decisions
**Form**: S + will + V1
...
#### Future Perfect
**Use**: Action completed BY a specific future time
**Form**: S + will + have + V3
...
**Use**: Continuous action up to a future point
