...
These are triploblastic acoelomates with bilateral symmetry. The body is flattened dorsoventrally, allowing gases and nutrients to diffuse across the surface. They have an incomplete digestive system (only a single opening) and a protonephridial excretory system.ganglion with paired nerve cords.
