...
1. Using s, p and d orbitals, write the electron configuration of copper (Z = 29) and explain why it does not follow the expected pattern.
2. Compare and contrast the lattice energies of NaF and NaI, and explain the difference in terms of ionic radius and charge density.
