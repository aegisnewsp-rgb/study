...
- Minimum speed at the bottom to complete the circle: v_bottom ≥ √(5gR). This follows from energy conservation between bottom and top (height difference h = 2R): ½mv_bottom² = ½mv_top² + mg(2R). Substituting v_top = √(gR) gives ½mv_bottom² = ½mgR + 2mgR = (5/2)mgR, so v_bottom² = 5gR and v_bottom = √(5gR).
