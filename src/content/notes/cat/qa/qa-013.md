...
Step 1: Choose the chairman from the 6 men: $6$ ways.
Step 2: Choose the remaining 4 members from the 9 people left (the 5 remaining men plus the 4 women). Since these 4 places carry no distinct role, this is a selection: $C(9, 4) = 126$.
...
The word "ERROR" has 5 letters: E, R, R, O, R — that is, 3 R's, 1 E, and 1 O.

$\frac{5!}{3!} = \frac{120}{6} = 20$ arrangements
