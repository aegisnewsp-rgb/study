...
const exam: ExamTemplate = {
  ...
  examPattern: `As notified by the Tamil Nadu Public Service Commission (https://tnpsc.gov.in), the TNPSC Group 1 Preliminary examination consists of a single objective paper with 200 questions carrying 300 marks (3 hours duration): 175 questions in General Studies and 25 questions in Aptitude and Mental Ability. There is no negative marking. The Main Written Examination consists of four descriptive papers of 3 hours each: Paper I Mandatory Tamil Eligibility Test (qualifying), and Papers II–IV (250 marks each). Together with the 100-mark oral interview, final selection rank is determined out of 850 marks as specified in the official TNPSC notification (https://tnpsc.gov.in).`,
  eligibility: `Per the official TNPSC recruitment notification (https://tnpsc.gov.in), candidates must hold a Bachelor's degree in any discipline from a recognized university. As prescribed in the official bulletin (https://tnpsc.gov.in), the age limits as of 1st July are 21 to 34 years for General candidates, with an upper age limit of 39 years for backward and scheduled classes (BC, MBC, SC, ST). Adequate knowledge of Tamil is mandatory as notified.`,
  subjects,
    durations: {
