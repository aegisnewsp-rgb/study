...
const exam: ExamTemplate = {
  ...
  examPattern: 'Preliminary Examination consists of two objective papers of 200 marks each (General Studies I and II) with 1/3 negative marking. Candidates must appear for both papers. Mains Examination has eight conventional (descriptive) papers: General Hindi (Paper 1, 150 marks), Essay (Paper 2, 150 marks), General Studies I (Paper 3, 200 marks — History, Geography), General Studies II (Paper 4, 200 marks — Indian Polity, Governance), General Studies III (Paper 5, 200 marks — Economy, Science, Technology), General Studies IV (Paper 6, 200 marks — Logical Reasoning, Decision Making), and two optional subject papers (Paper 7 and 8, 200 marks each). The Interview/Personality Test carries 100 marks — check the official UPPSC information bulletin for the current marks split. Final selection is based on Mains and Interview combined.',
  eligibility: 'Candidates must be Indian citizens aged between 21-40 years for general category with educational relaxation for SC/ST/OBC — check the official UPPSC notification for the current age limits. Educational qualification is a bachelor\'s degree in any discipline from a recognized university. Knowledge of Hindi language is essential. Candidates must be domiciled in Uttar Pradesh for certain posts. Final year students can apply provisionally. Physical fitness is required for certain positions including DSP. Age relaxation: 5 years for SC/ST, 3 years for OBC.',
  country: 'india',
  subjects,
    durations: {
    '1h': makeRoadmap(subjects, '1h', 1, 'Study plan for UPPSC PCS — 1 Hour'),
    '2h': makeRoadmap(subjects, '2h', 1, 'Study plan for UPPSC PCS — 2 Hours'),
    '3h': makeRoadmap(subjects, '3h', 1, 'Study plan for UPPSC PCS — 3 Hours'),
    '5h': makeRoadmap(subjects, '5h', 1, 'Study plan for UPPSC PCS — 5 Hours'),
    '12h': makeRoadmap(subjects, '12h', 1, 'Study plan for UPPSC PCS — 12 Hours'),
    '1d': makeRoadmap(subjects, '1d', 1, 'Study plan for UPPSC PCS — 1 Day'),
    '2d': makeRoadmap(subjects, '2d', 2, 'Study plan for UPPSC PCS — 2 Days'),
    '3d': makeRoadmap(subjects, '3d', 3, 'Study plan for UPPSC PCS — 3 Days'),
    '5d': makeRoadmap(subjects, '5d', 5, 'Study plan for UPPSC PCS — 5 Days'),
    '7d': makeRoadmap(subjects, '7d', 7, 'Study plan for UPPSC PCS — 1 Week'),
    '10d': makeRoadmap(subjects, '10d', 10, 'Study plan for UPPSC PCS — 10 Days'),
    '2w': makeRoadmap(subjects, '2w', 14, 'Study plan for UPPSC PCS — 2 Weeks'),
    '1mo': makeRoadmap(subjects, '1mo', 30, 'Study plan for UPPSC PCS — 1 Month'),
    '2mo': makeRoadmap(subjects, '2mo', 60, 'Study plan for UPPSC PCS — 2 Months'),
    ...
    '1yr': makeRoadmap(subjects, '1yr', 365, 'Study plan for UPPSC PCS — 1 Year'),
    '2yr': makeRoadmap(subjects, '2yr', 730, 'Study plan for UPPSC PCS — 2 Years'),
  },
  rescueMode: {
    name: 'Rescue Mode',
  ...
  prepOverview:
    'UPPSC PCS-style exams typically run Prelims → Mains → Interview with heavy Uttar Pradesh GS weight. Phase 1: NCERT + standard GS; Phase 2: UP special (history, geography, schemes, polity); Phase 3: answer writing and full mocks. Confirm paper structure and CSAT rules on uppsc.up.nic.in for the live notification. Use StudyRoadmap roadmaps for remaining weeks.',
  commonMistakes: [
    'Ignoring Uttar Pradesh-specific GS while only reading national materials.',
    'No timed CSAT practice when the notice makes Paper II qualifying or scoring.',
    'Weak mains answer structure and word-limit discipline.',
    'Outdated optional/GS lists from old advertisements.',
    'Unstructured current affairs without monthly revision notes.'
  ],
