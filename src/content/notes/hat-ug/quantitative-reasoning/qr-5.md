...
diagramPrompt: "Educational diagram illustrating Profit, Loss and Discount with clear labels, white background, exam-style illustration"
...
Step 1 — Apply 20%: 2,500 × 0.80 = 2,000.
Step 2 — Apply 10%: 2,000 × 0.90 = 1,800, so SP = PKR 1,800.
Step 3 — Single equivalent: d = 20 + 10 − (20×10)/100 = 28%.
Check: 2,500 × (1 − 0.28) = 2,500 × 0.72 = 1,800 ✓.
...
- **[View this topic in your HAT-UG (HEC Aptitude Test - Undergraduate) roadmap](/roadmap/?exam=hat-ug&duration=1mo)** — see where "Profit, Loss and Discount" fits in your personalised plan
