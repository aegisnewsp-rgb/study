...
Core concept: Topic 4 is an important topic in ('physics', 'Physics') for ECAT (Engineering)
...
Overview: Topic 4 is a key ('physics', 'Physics') topic for ECAT (Engineering)
...
Full coverage: Topic 4 in ('physics', 'Physics') for ECAT (Engineering) preparation
