...
| Species | Reagent | Observation | Equation (ionic) |
|---|---|---|---|
| NH₄⁺ | NaOH, warm | NH₃ gas; damp red litmus → blue; white smoke with HCl | NH₄⁺ + OH⁻ → NH₃ + H₂O |
| NO₂⁻ | KI + dilute H₂SO₄ | Brown solution (I₂ liberated) | 2NO₂⁻ + 2I⁻ + 4H⁺ → I₂ + 2NO + 2H₂O |
| NO₃⁻ | FeSO₄ + conc H₂SO₄ (layered) | Brown ring at junction | NO₃⁻ + 3Fe²⁺ + 4H⁺ → NO + 3Fe³⁺ + 2H₂O; NO + Fe²⁺ → [Fe(H₂O)₅(NO)]²⁺ |
...
- **[View this topic in your UNEB UACE (Uganda) roadmap](/roadmap/?exam=uneb&duration=1mo)** — see where "Topic 6" fits in your personalised plan
