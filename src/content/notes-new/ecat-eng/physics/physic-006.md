...
Core concept: Topic 6 is an important topic in ('physics', 'Physics') for ECAT (Engineering)
...
Overview: Topic 6 is a key ('physics', 'Physics') topic for ECAT (Engineering)
...
Full coverage: Topic 6 in ('physics', 'Physics') for ECAT (Engineering) preparation
