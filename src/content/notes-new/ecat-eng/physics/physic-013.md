...
Core concept: Topic 13 is an important topic in ('physics', 'Physics') for ECAT (Engineering)
...
Overview: Topic 13 is a key ('physics', 'Physics') topic for ECAT (Engineering)
...
Full coverage: Topic 13 in ('physics', 'Physics') for ECAT (Engineering) preparation
