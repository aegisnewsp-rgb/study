...
**Trial Balance** — ICAN (Nigeria) Study Guide

**Preparation of a Trial Balance — Step by Step**

1. Ensure all ledger accounts are balanced (debit balances placed on the debit column, credit balances on the credit column)
2. List all account names with their debit or credit balances
3. Total the debit column and the credit column
4. If the totals are equal, the trial balance is said to "agree" — indicating that the double-entry has been mathematically maintained
5. If the totals differ, calculate the difference and investigate
