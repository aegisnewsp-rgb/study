...
topic: scienc-015
topicName: "Genetics, Heredity and Molecular Biology"
weight: 3
country: srilanka
...
$$5' \rightarrow 3' \text{ antiparallel strands}$$
...
⚡ **A/L PYQ**: "Describe the process of DNA replication"
Answer: DNA replication is semi-conservative — each daughter DNA molecule contains one original strand and one newly synthesized strand. Enzymes involved include helicase (unwinding), DNA polymerase (new strand synthesis), and ligase (joining fragments).
