...
1. **Direct combination:** Metal + Non-metal → Salt
   $$2Na + Cl_2 \rightarrow 2NaCl$$

2. **Acid + Metal:** (for soluble salts — metals above hydrogen in reactivity series)
...
For a strong acid with concentration $c$ mol/L:
$$[H^+] = c \times \text{basicity of acid}$$

For a strong base with concentration $c$ mol/L:
$$[OH^-] = c \times \text{acidity of base}$$
...
For weak acids: $HA \rightleftharpoons H^+ + A^-$
$$K_a = \frac{[H^+][A^-]}{[HA]}$$
...
For weak bases: $B + H_2O \rightleftharpoons BH^+ + OH^-$
$$K_b = \frac{[BH^+][OH^-]}{[B]}$$
...
**Acidic buffer:** Weak acid + its conjugate base (e.g., $CH_3COOH/CH_3COONa$)
**Basic buffer:** Weak base + its conjugate acid (e.g., $NH_3/NH_4Cl$)
...
Salts of weak acid + strong base: Basic (pH > 7) — e.g., $Na_2CO_3$
Salts of strong acid + weak base: Acidic (pH < 7) — e.g., $NH_4Cl$
Salts of weak acid + weak base: Depends on relative strengths
