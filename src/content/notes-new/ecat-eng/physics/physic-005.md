...
Core concept: Topic 5 is an important topic in ('physics', 'Physics') for ECAT (Engineering)
...
Overview: Topic 5 is a key ('physics', 'Physics') topic for ECAT (Engineering)
...
Full coverage: Topic 5 in ('physics', 'Physics') for ECAT (Engineering) preparation
