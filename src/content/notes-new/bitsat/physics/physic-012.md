...
Core concept: Topic 12 is an important topic in ('physics', 'Physics') for BITSAT
...
Overview: Topic 12 is a key ('physics', 'Physics') topic for BITSAT
...
Full coverage: Topic 12 in ('physics', 'Physics') for BITSAT preparation
