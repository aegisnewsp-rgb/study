...
Core concept: Topic 1 is an important topic in ('physics', 'Physics') for MHT-CET
...
Overview: Topic 1 is a key ('physics', 'Physics') topic for MHT-CET
...
Full coverage: Topic 1 in ('physics', 'Physics') for MHT-CET preparation
