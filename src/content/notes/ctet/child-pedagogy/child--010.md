...
1. Assessment done during instruction to monitor learning and provide feedback is called:
   a) Summative assessment
   b) Diagnostic assessment
   c) Formative assessment
   d) Evaluation

2. Bloom's taxonomy moves from lower to higher order. "Analyze" comes before:
   a) Knowledge
   b) Comprehension
   c) Evaluation
   d) Remembering

3. A test that gives consistent scores when repeated has:
   a) Validity
   b) Reliability
   c) Objectivity
   d) Comprehensiveness
...
4. CCE stands for:
   ...
   c) Continuous Curriculum Evaluation
   d) Class Comprehensive Evaluation

5. Feedback should be:
   a) Focused on the person, not the task
   b) Given only at the end of the term
   c) Specific, timely, and focused on improvement
   d) Always negative to drive improvement
