...
Core concept: Topic 1 is an important topic in ('physics', 'Physics') for KUET
...
Overview: Topic 1 is a key ('physics', 'Physics') topic for KUET
...
Full coverage: Topic 1 in ('physics', 'Physics') for KUET preparation
