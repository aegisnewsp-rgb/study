...
1. Conflating GATT (treaty, 1947) with WTO (organization, 1995).
2. Forgetting that **ICJ judgments are binding** but the Court has no enforcement mechanism — enforcement runs through the Security Council.
3. Assuming the **UN General Assembly resolutions** are binding — only Security Council resolutions under Chapter VII bind members.
4. Mixing IMF (surveillance, short-term liquidity) with World Bank (long-term development lending).
