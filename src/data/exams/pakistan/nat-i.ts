...
const verbalReasoning: Subject = {
  ...
  topics: [
    { id: 'vr-1', name: 'Analogies (Word Relationships)', weight: 4 },
    { id: 'vr-2', name: 'Synonyms', weight: 3 },
    { id: 'vr-3', name: 'Antonyms', weight: 3 },
    { id: 'vr-4', name: 'Sentence Completion', weight: 4 },
    { id: 'vr-5', name: 'One Word Substitution', weight: 3 },
    { id: 'vr-6', name: 'Idioms and Phrases', weight: 3 },
    { id: 'vr-7', name: 'Spelling and Vocabulary', weight: 3 },
    { id: 'vr-8', name: 'Reading Comprehension', weight: 5 },
    { id: 'vr-9', name: 'Verbal Analogies (Logical)', weight: 4 },
    { id: 'vr-10', name: 'Odd One Out (Words)', weight: 3 },
    { id: 'vr-11', name: 'Jumbled Sentences', weight: 3 },
    { id: 'vr-12', name: 'Grammar: Agreement and Usage', weight: 3 },
    { id: 'vr-13', name: 'Critical Reading', weight: 4 },
    { id: 'vr-14', name: 'Inference and Conclusion', weight: 4 },
    { id: 'vr-15', name: 'Contextual Vocabulary', weight: 3 },
  ]
};
...
const analyticalReasoning: Subject = {
  ...
  topics: [
    ...
    { id: 'ar-4', name: 'Series Completion (Numbers)', weight: 4 },
    { id: 'ar-5', name: 'Series Completion (Letters)', weight: 3 },
    { id: 'ar-6', name: 'Classification and Odd One Out', weight: 3 },
    { id: 'ar-7', name: 'Seating Arrangements', weight: 4 },
    { id: 'ar-8', name: 'Puzzles (Linear and Circular)', weight: 4 },
    { id: 'ar-9', name: 'Syllogisms and Logical Deduction', weight: 5 },
    { id: 'ar-10', name: 'Statement and Assumptions', weight: 4 },
    { id: 'ar-11', name: 'Statement and Arguments', weight: 4 },
    { id: 'ar-12', name: 'Cause and Effect', weight: 3 },
...
const quantitativeReasoning: Subject = {
  ...
  topics: [
    { id: 'qr-1', name: 'Number System and Properties', weight: 4 },
    { id: 'qr-2', name: 'Fractions and Decimals', weight: 3 },
    { id: 'qr-3', name: 'Percentages', weight: 4 },
    { id: 'qr-4', name: 'Profit and Loss', weight: 4 },
    { id: 'qr-5', name: 'Ratio and Proportion', weight: 4 },
    { id: 'qr-6', name: 'Time, Distance and Work', weight: 4 },
    { id: 'qr-7', name: 'Simple and Compound Interest', weight: 3 },
    { id: 'qr-8', name: 'Algebraic Expressions', weight: 4 },
    { id: 'qr-9', name: 'Linear Equations', weight: 4 },
    { id: 'qr-10', name: 'Quadratic Equations', weight: 3 },
    { id: 'qr-11', name: 'Geometry: Lines, Angles and Triangles', weight: 4 },
    { id: 'qr-12', name: 'Circles and Mensuration', weight: 3 },
    { id: 'qr-13', name: 'Data Interpretation (Charts/Tables)', weight: 4 },
    { id: 'qr-14', name: 'Probability and Permutations', weight: 4 },
    { id: 'qr-15', name: 'Averages and Statistics', weight: 3 },
  ]
};
...
const subjectKnowledge: Subject = {
  ...
  topics: [
    { id: 'sub-1', name: 'Physics: Mechanics', weight: 4 },
    { id: 'sub-2', name: 'Physics: Electricity and Magnetism', weight: 4 },
    { id: 'sub-3', name: 'Chemistry: Physical Chemistry', weight: 4 },
    { id: 'sub-4', name: 'Chemistry: Organic Chemistry', weight: 4 },
    { id: 'sub-5', name: 'Biology: Cell Biology and Genetics', weight: 4 },
    { id: 'sub-6', name: 'Biology: Human Physiology', weight: 4 },
    { id: 'sub-7', name: 'Mathematics: Algebra and Calculus', weight: 4 },
    { id: 'sub-8', name: 'Mathematics: Geometry and Trigonometry', weight: 4 },
    { id: 'sub-9', name: 'Computer Science: Fundamentals', weight: 3 },
    { id: 'sub-10', name: 'Computer Science: Programming Basics', weight: 3 },
  ]
};
