...
Core concept: Topic 1 is an important topic in ('physics', 'Physics') for ECAT (Engineering)
...
Overview: Topic 1 is a key ('physics', 'Physics') topic for ECAT (Engineering)
...
Full coverage: Topic 1 in ('physics', 'Physics') for ECAT (Engineering) preparation
