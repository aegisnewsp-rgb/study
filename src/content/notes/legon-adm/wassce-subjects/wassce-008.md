...
topic: wassce-008
topicName: "Topic 8: Linear Equations and Inequalities"
weight: 3
country: ghana
...
Step 3 — Collect variable terms on left:
8x - 3x = 19 + 12
...
Step 1 — Find LCM of denominators (4, 3, 6) = 12
Step 2 — Multiply entire equation by 12:
12 × [(2x + 3)/4] - 12 × [(x - 1)/3] = 12 × (5/6)
3(2x + 3) - 4(x - 1) = 10
...
Add (1) and (2): 3x = 10 → x = 10/3
Substitute: 10/3 - y = 2 → y = 10/3 - 2 = 4/3
Solution: **(10/3, 4/3)**
