...
topic: rbi-fin-003
topicName: "Balance Sheet & Financial Statement Analysis"
tier: unified
weight: 3
...
**DuPont Analysis** is the most powerful framework — it breaks ROE into three components:
$$ROE = \underbrace{\frac{\text{Net Profit}}{\text{Revenue}}}_{\text{Profit Margin}} \times \underbrace{\frac{\text{Revenue}}{\text{Total Assets}}}_{\text{Asset Turnover}} \times \underbrace{\frac{\text{Total Assets}}{\text{Equity}}}_{\text{Financial Leverage}}$$
