export const gk: Subject = {
  ...
  topics: [
    ...
    { id: 'gk-006', name: 'Human Rights in Uganda', weight: 3 as const },
    { id: 'gk-007', name: 'Notable Ugandan Legal Cases and Practitioners', weight: 3 as const },
    { id: 'gk-008', name: 'Key Legislation and the Ugandan Legal Framework', weight: 3 as const }
  ]
};
