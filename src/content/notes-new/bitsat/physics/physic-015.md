...
Core concept: Topic 15 is an important topic in ('physics', 'Physics') for BITSAT
...
Overview: Topic 15 is a key ('physics', 'Physics') topic for BITSAT
...
Full coverage: Topic 15 in ('physics', 'Physics') for BITSAT preparation
