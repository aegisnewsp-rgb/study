...
**⚡ Exam Tips for MDCAT:**
- Restriction enzymes are named after the organism they were derived from — e.g., *Eco*RI from *E. coli* strain R
...
|---|---|---|
| **Restriction Enzymes** | Cut DNA at specific sequences | *Hind*III cuts at AAGCTT |
...
- *Eco*RI recognises: 5'-GAATTC-3'
- Creates sticky ends (overhanging) or blunt ends
- *Bam*HI: GGATCC | *Hind*III: AAGCTT | *Sal*I: GATCG
