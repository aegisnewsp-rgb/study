...
1. **Return:** What is the expected benefit (revenue, cost savings, strategic value)? Is it worth the investment?
2. **Risk:** What can go wrong? How likely, how severe, and can it be mitigated?
3. **Time:** When does the return materialise? Is the waiting worth it relative to the cost of capital?
