...
1. **Carol Gilligan's Critique**: Women may use care-oriented (not justice-oriented) reasoning — Gilligan proposed an "Ethic of Care" vs Kohlberg's "Ethic of Justice"
2. Cultural bias: Most research done on American boys; stages may not apply universally
3. Moral reasoning doesn't always predict moral behavior (knowing what's right ≠ doing it)
4. People's moral reasoning can regress under stress
...
**Dilemma: The Heinz Dilemma** (Kohlberg's famous case)
...
**Kohlberg → Rest's Four-Component Model**:
James Rest later refined Kohlberg's theory identifying four psychological components of moral behavior:
1. **Moral sensitivity**: Recognizing that a situation has a moral dimension
2. **Moral judgment**: Deciding what is right (Kohlberg's stages)
3. **Moral motivation**: Prioritizing moral values over other values
4. **Moral character**: Persisting with moral action despite obstacles
