...
Core concept: Topic 1 is an important topic in ('english', 'English') for SLMC Medical (Sri Lanka)
...
Overview: Topic 1 is a key ('english', 'English') topic for SLMC Medical (Sri Lanka)
...
Full coverage: Topic 1 in ('english', 'English') for SLMC Medical (Sri Lanka) preparation
