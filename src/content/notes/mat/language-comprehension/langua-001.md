...
1. **Survey (30 seconds):** Read the title if given, then the first and last paragraphs. Note the broad topic and the author's apparent conclusion.

2. **Question (ongoing):** As you read each paragraph, ask: "What is the author trying to establish here?" and "How does this connect to the passage's main argument?"

3. **Read (2–3 minutes):** Read the full passage at a steady pace. Do not linger on difficult sentences — mark them and continue. Your goal is overall comprehension, not immediate mastery of every detail.

4. **Recall (30 seconds):** After reading, close the passage mentally and ask: "What is this passage about in one sentence? What is the author's purpose?"

5. **Answer:** Read each question, return to the passage for the specific reference, then answer.
