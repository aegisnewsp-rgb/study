...
topic: child--003
topicName: Vygotsky's Sociocultural Theory
weight: 3
country: india
...
1. **Mediated learning**: Teachers should actively mediate learning experiences, not just present content
2. **Collaborative learning**: Pair advanced learners with struggling learners — both benefit
3. **Scaffolding**: Provide temporary supports that gradually withdraw
4. **ZPD-based instruction**: Identify what the child is close to mastering and build from there
5. **Language-rich environment**: Encourage discussion, questioning, explanation in the classroom
6. **Cultural relevance**: Learning is rooted in cultural context — connect to students' lived experiences
