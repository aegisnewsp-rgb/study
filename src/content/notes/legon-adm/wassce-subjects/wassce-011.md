...
**Example — Area of Trapezium:**
A trapezium with parallel sides 8 cm and 12 cm, and height 5 cm:
...
A cylindrical water tank has radius 3 m and height 7 m:
Volume = π × 3² × 7 = π × 9 × 7 = **63π m³ ≈ 197.9 m³**
...
1. Using the wrong unit in calculations (metres vs centimetres)
2. Confusing diameter and radius in circle formulas
3. Forgetting that the hypotenuse is the longest side in a right-angled triangle
4. Mixing up similar and congruent shapes
5. In volume problems, using the wrong dimension for height/slant height

**Problem-Solving Strategy:**
1. Draw a clear diagram and label all given measurements
2. Identify which geometric principles apply
3. Set up equations using known relationships
4. Solve step by step, checking each calculation
5. Include units in your final answer (cm², m³, degrees, etc.)
...
*Proof by area subtraction:*
Consider a square of side (a + b) containing four identical right-angled triangles. The remaining central area is a square of side c. Hence:
(a + b)² = 4(½ab) + c²
a² + 2ab + b² = 2ab + c²
Therefore: a² + b² = c²
...
To find the space diagonal of a cuboid with dimensions l, b, h:
d² = l² + b² + h²

For a cuboid measuring 3 cm × 4 cm × 12 cm:
...
For P(3, 7) and Q(9, -1):
Distance = √[(9-3)² + (-1-7)²] = √[36 + 64] = √100 = **10**
Midpoint = ((3+9)/2, (7+(-1))/2) = (6, 3)
...
If two similar shapes have areas A₁ and A₂, and linear scale factor k:
A₂/A₁ = k²

If the linear scale factor is 3:1 and the smaller area is 20 cm²:
Larger area = 20 × 3² = **180 cm²**

**WASSCE Examination Patterns:**

WASSCE geometry questions typically include:
1. Angle calculations using geometric properties (Objective)
2. Pythagoras theorem applications (Objective and Theory)
3. Area and volume calculations (Objective and Theory)
4. Circle geometry including tangent properties (Theory)
5. Bearing and distance problems (Theory)
