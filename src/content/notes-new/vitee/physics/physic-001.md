...
Core concept: Topic 1 is an important topic in ('physics', 'Physics') for VITEEE
...
Overview: Topic 1 is a key ('physics', 'Physics') topic for VITEEE
...
Full coverage: Topic 1 in ('physics', 'Physics') for VITEEE preparation
