...
**Blood Flow**:
Systemic → SVC/IVC → RA → Tricuspid → RV → Pulmonary valve → PA → Lungs → PV → LA → Mitral → LV → Aortic valve → Aorta → Systemic
...
**Preload**: End-diastolic volume/pressure (venous return)
**Afterload**: Pressure ventricle works against (systemic vascular resistance)
**Contractility**: Inotropic state (sympathetic activation increases)
