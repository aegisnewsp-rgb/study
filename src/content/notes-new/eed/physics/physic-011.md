...
Core concept: Topic 11 is an important topic in ('physics', 'Physics') for EGE (Russia)
...
Overview: Topic 11 is a key ('physics', 'Physics') topic for EGE (Russia)
...
Full coverage: Topic 11 in ('physics', 'Physics') for EGE (Russia) preparation
