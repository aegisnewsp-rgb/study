export const finance: Subject = {
  ...
  topics: [
    ...
    { id: 'financ-004', name: 'Financial Inclusion and Digital Finance', weight: 4 as const, description: 'Financial inclusion and digital finance: PMJDY and BC-agent outreach, NPCI rails (UPI, IMPS, AePS), digital lending, and the RBI-NPCI-bank division of roles.' },
    ...
    { id: 'financ-008', name: 'Capital Budgeting', weight: 3 as const, description: 'Capital budgeting: ranking long-term capex proposals by NPV, IRR, payback, discounted payback and profitability index, plus capital rationing decisions.' },
