...
**Hydrogen Bonding:**
Alcohols can form hydrogen bonds because the –OH group contains:
...
**With formaldehyde (HCHO):** R–MgBr + HCHO → R–CH₂–OH (primary alcohol)
**With aldehydes:** R–MgBr + R'–CHO → R–CH(R')–OH (secondary alcohol)
**With ketones:** R–MgBr + R'–CO–R'' → R–C(R')(R'')–OH (tertiary alcohol)
...
No oxidation under these conditions without C–C bond cleavage (tertiary alcohols are resistant to oxidation)
