...
Core concept: Topic 8 is an important topic in ('physics', 'Physics') for EGE (Russia)
...
Overview: Topic 8 is a key ('physics', 'Physics') topic for EGE (Russia)
...
Full coverage: Topic 8 in ('physics', 'Physics') for EGE (Russia) preparation
