...
weight: 4
country: nigeria
generated: "2026-03-24T08:32:07.642509"
...
**Chemical Equilibrium** — Key Facts for WAEC WASSCE
...
- **The Equilibrium Constant $K_c$**: For $aA + bB \rightleftharpoons cC + dD$:
  $$K_c = \frac{[C]^c[D]^d}{[A]^a[B]^b}$$
  $K_c > 1$: equilibrium lies to the right (products favoured). $K_c < 1$: equilibrium lies to the left (reactants favoured).
...
**Chemical Equilibrium** — WAEC WASSCE Chemistry Study Guide
...
*Industrial Example — The Haber Process for Ammonia Synthesis*:
$$\mathrm{N_2(g) + 3H_2(g) \rightleftharpoons 2NH_3(g)} \quad \Delta H = -92 \text{ kJ mol}^{-1}$$
...
**Chemical Equilibrium** — Comprehensive WAEC Chemistry Notes
...
Rate forward = $k_f[A]^a[B]^b$
Rate reverse = $k_r[C]^c[D]^d$
...
For a sparingly soluble salt like silver chloride:
...
Similarly, for calcium fluoride: $\mathrm{CaF_2(s) \rightleftharpoons Ca^{2+}(aq) + 2F^-(aq)}$
...
For the weak acid dissociation equilibrium $\mathrm{HA \rightleftharpoons H^+ + A^-}$:
...
$[\text{PCl}_5] = 0.80 - 0.1305 = 0.670$ mol dm⁻³
$[\text{PCl}_3] = [\text{Cl}_2] = 0.1305$ mol dm⁻³
