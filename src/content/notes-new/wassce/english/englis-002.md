...
Core concept: Topic 2 is an important topic in ('english', 'English') for WASSCE (Ghana)
...
Overview: Topic 2 is a key ('english', 'English') topic for WASSCE (Ghana)
...
Full coverage: Topic 2 in ('english', 'English') for WASSCE (Ghana) preparation
