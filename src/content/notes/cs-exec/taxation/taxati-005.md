...
**Step 1:** Determine all payments due or made in the previous year (April 1 to March 31)
**Step 2:** Identify exemptions/deductions under Section 10
**Step 3:** Compute "Salary" after exemptions = Gross Salary minus Exemptions
**Step 4:** Add income from other heads (HP, Business, etc.) to get Gross Total Income
**Step 5:** Apply deductions under Chapter VI-A (80C to 80U) to get taxable income
**Step 6:** Calculate tax on taxable income as per slab rates
**Step 7:** Claim relief under Section 89 (arrears) if applicable

### 2.5 TDS on Salary — Practical Procedure

1. **Employee submits Form 12BB** (now via new Form 12BA in some cases) at the beginning of the financial year listing estimated investments
2. **Employer computes estimated income** for the year
3. **TDS is deducted** in each pay period based on estimated tax liability
4. **TDS is deposited** with government within 7 days of month-end (for Government) or by 7th of next month (for others)
5. **Form 16 is issued** at end of financial year
...
**"Contractor"** includes any person who does work pursuant to a contract agreement.
**"Work"** includes:
- Manufacturing or processing
...
1. Apply in **Form 49B** (online or offline)
2. Submit to NSDL e-governance or TIN facilitation centers
3. TAN is allotted within 10-15 working days
...
1. **Prepare e-TDS return** using approved utility
2. **Validate return** using AST (Aadhaar-Seeding Validation)
3. **Generate control totals**
4. **Upload return** on NSDL/TIN website
5. **Receive Provisional Receipt** (receipt number and date)
6. **Accept TDS certificate** (Form 16/16A) from TRACES after reconciliation
...
1. The deductee files an application in **Form 13** to the Assessing Officer
2. The AO considers the income, claim of exemptions, deductions, and estimates tax liability
3. A certificate is issued specifying the **rate of TDS** (lower or nil)
4. The certificate is given to the deductor, who then deducts TDS at the specified rate
...
1. Seller collects tax from buyer at time of sale
2. Seller deposits TCS to government treasury
3. Seller files **Form 27EQ** (quarterly TCS return)
4. Seller issues **Form 27D** (TCS certificate) to the buyer
...
TDS is deducted by the **payer** at the time of payment, while TCS is collected by the **seller** at the time of sale of goods. TDS covers payments like salary, interest, commission, etc. TCS covers sale of specific goods like alcohol, scrap, motor vehicles.

**Q2. What happens if a deductor doesn't file TDS returns?**
Penalty under Section 271H, interest under Section 201, and potential prosecution under Section 276B for non-payment.

**Q3. Can TDS be claimed as refund?**
Yes, if TDS deducted exceeds the actual tax liability, the excess can be claimed as refund by filing Income Tax Return.

**Q4. What is the penalty for not obtaining TAN?**
Penalty of up to ₹10,000 under Section 272BB.

**Q5. What is the threshold for TDS on rent under Section 194-IB?**
₹2,40,000 per annum (for individual/HUF payers).

**Q6. What is the TDS rate on professional fees under Section 194J?**
10% if PAN is quoted; 20% if PAN is not quoted.
...
> 1. TDS rates for all sections (192, 193, 194, 194A, 194C, 194H, 194J, 194-IB, 194-IA)
> 2. TAN requirements and penalties
> 3. Form 16 structure (Part A and Part B)
> 4. Section 197 — Lower/nil deduction certificate
> 5. TCS provisions under Section 206C (especially 1H — goods sale)
> 6. Interest and penalties for TDS defaults
