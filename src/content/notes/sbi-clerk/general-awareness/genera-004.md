...
**GDP at Constant Prices (Real GDP)**: Uses base year prices; measures actual growth
**GDP at Current Prices (Nominal GDP)**: Uses current prices; affected by inflation
...
GDP = Compensation of Employees + Gross Profits + Gross Mixed Income + Net Indirect Taxes

#### 3. Expenditure Method
Sum of all expenditures on final goods:
GDP = C + I + G + (X − M)
...
**Composition**: Prime Minister (Chairperson), Vice Chairperson, Governing Council (Chief Ministers of all States, Lt. Governors of UTs)
...
**Implemented**: July 1, 2017 (India's biggest tax reform)
**What it replaced**: Excise duty, VAT, service tax, octroi, entry tax, luxury tax — over 17 indirect taxes
