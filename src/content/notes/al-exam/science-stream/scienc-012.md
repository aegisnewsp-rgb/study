...
topic: scienc-012
topicName: "Research Methodology, Scientific Skills, and Practical Botany"
weight: 3
country: srilanka
...
$$\text{Scale bar method} = \frac{\text{Real length}}{\text{Bar length}}$$
...
**Mark-Recapture Method** (population estimation):
$$\text{Population size} = \frac{\text{Marked}_1 \times \text{Total}_2}{\text{Recaptured}_2}$$
