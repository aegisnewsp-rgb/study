...
| Equilibrium | Kc expression |
|---|---|
| N₂ + 3H₂ ⇌ 2NH₃ | Kc = [NH₃]² / ([N₂][H₂]³) |
| 2SO₂ + O₂ ⇌ 2SO₃ | Kc = [SO₃]² / ([SO₂]²[O₂]) |
| CH₃COOH + C₂H₅OH ⇌ CH₃COOC₂H₅ + H₂O | Kc = ([ester][H₂O]) / ([acid][alcohol]) |
...
- **[View this topic in your UNEB UACE (Uganda) roadmap](/roadmap/?exam=uneb&duration=1mo)** — see where "Topic 9" fits in your personalised plan
