...
| Level | Goal | Family-practice example |
|---|---|---|
| Primordial | Prevent emergence of risk factors | School-based anti-tobacco policy |
| Primary | Reduce incidence | MMR vaccination, smoking cessation |
| Secondary | Early detection | Biennial mammogram 40–74 (MoH) |
| Tertiary | Reduce complications | Diabetic foot clinic, cardiac rehab |
| Quaternary | Avoid over-medicalisation | Limiting unnecessary antibiotics |
