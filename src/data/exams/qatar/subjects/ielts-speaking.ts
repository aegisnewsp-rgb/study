// IELTS Speaking — International English Language Testing System (Qatar).
// Awarding body: jointly owned by the British Council, IDP: IELTS Australia,
// and Cambridge University Press & Assessment. Three parts in 11-14 minutes:
// Part 1 introduction and interview (4-5 min), Part 2 individual long turn
// with 1 minute preparation and 1-2 minutes speaking (3-4 min including
// prep), and Part 3 two-way discussion (4-5 min). The same Speaking test
// is used for both Academic and General Training. In Qatar the test is
// administered face-to-face at the British Council Doha centre or the IDP
// IELTS Doha centre. Source: IELTS Academic Speaking test format,
...
// Re-check the live part structure, the in-person vs video-call speaking
// option, and timing on ielts.org before committing any revision plan to a
// student.
