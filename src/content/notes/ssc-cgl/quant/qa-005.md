...
- SI vs CI difference for 2 years = $P \times \left(\frac{R}{100}\right)^2$
...
- SI = $\frac{PRT}{100}$
- CI ≈ SI + Interest on the accumulated interest

For 2 years specifically, the difference reduces to a clean shortcut:
$$CI - SI = P \times \left(\frac{R}{100}\right)^2$$

This shortcut applies to a 2-year period. For longer periods, use the full formula and subtract.
...
**Derivation of the 2-Year CI − SI Shortcut:**

Over 2 years:
$$SI = \frac{PRT}{100} = \frac{2PR}{100}$$
$$CI = P\left[\left(1 + \frac{R}{100}\right)^2 - 1\right] = P\left[\frac{2R}{100} + \frac{R^2}{10000}\right] = \frac{2PR}{100} + \frac{PR^2}{10000}$$

Subtracting:
$$CI - SI = \frac{PR^2}{10000} = P\left(\frac{R}{100}\right)^2$$

This confirms the shortcut used in the Standard tier.
...
Solution:
First find the principal from the given CI.
$$CI = P\left[(1.1)^2 - 1\right] = P \times 0.21$$
$$2100 = 0.21P \Rightarrow P = 10000$$

Now compute the SI for the same sum, rate, and time:
$$SI = \frac{P \times R \times T}{100} = \frac{10000 \times 10 \times 2}{100} = ₹2,000$$

As a cross-check, the 2-year shortcut gives:
$$CI - SI = P\left(\frac{R}{100}\right)^2 = 10000 \times (0.1)^2 = ₹100$$
So SI = CI − 100 = 2100 − 100 = ₹2,000, which matches.
