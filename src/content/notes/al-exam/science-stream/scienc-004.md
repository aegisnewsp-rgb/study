...
topic: scienc-004
topicName: "Plant Physiology: Nutrition and Transport"
weight: 3
country: al
...
**Path of Water**:
$$\text{Root hairs} \rightarrow \text{Cortex} \rightarrow \text{Endodermis} \rightarrow \text{Xylem} \rightarrow \text{Stem} \rightarrow \text{Leaves}$$
