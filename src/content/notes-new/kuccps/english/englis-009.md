...
Core concept: Topic 9 is an important topic in ('english', 'English') for KUCCPS (Kenya)
...
Overview: Topic 9 is a key ('english', 'English') topic for KUCCPS (Kenya)
...
Full coverage: Topic 9 in ('english', 'English') for KUCCPS (Kenya) preparation
