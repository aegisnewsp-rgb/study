...
1. **Common factor method:** Extract the highest common factor (HCF) from all terms. Example: 6x²y + 9xy² = 3xy(2x + 3y)
2. **Difference of two squares (DOTS):** a² − b² = (a + b)(a − b). Example: x² − 16 = (x + 4)(x − 4)
3. **Trinomial factorisation:** For ax² + bx + c, find two numbers that multiply to ac and sum to b. Example: x² + 7x + 12 = (x + 3)(x + 4) because 3 × 4 = 12 and 3 + 4 = 7
4. **Completing the square:** Express ax² + bx + c in the form a(x − p)² + q
...
Example: 3x + 2y = 16 and 2x − y = 3
Multiply the second equation by 2: 4x − 2y = 6
Add to the first: 7x = 22 → x = 22/7
Substitute back: 2(22/7) − y = 3 → y = 44/7 − 3 = 23/7
