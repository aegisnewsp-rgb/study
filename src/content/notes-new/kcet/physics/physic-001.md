...
Core concept: Topic 1 is an important topic in ('physics', 'Physics') for KCET
...
Overview: Topic 1 is a key ('physics', 'Physics') topic for KCET
...
Full coverage: Topic 1 in ('physics', 'Physics') for KCET preparation
