...
topic: math-4
topicName: "Algebraic Expressions and Operations"
weight: 5
country: nigeria
generated: "2026-03-24T08:32:07.664468"
diagramPrompt: "Mathematical diagram showing Algebraic Expressions and Operations concept with coordinate axes, labeled points, geometric shapes shaded appropriately, clean black and white style"
...
*Example:* $\frac{3}{x+2} + \frac{5}{x-3}$
LHS: $\frac{3(x-3) + 5(x+2)}{(x+2)(x-3)} = \frac{3x-9+5x+10}{x^2-x-6} = \frac{8x+1}{x^2-x-6}$
...
Solve $3(x - 2) = 2(x + 5) + 7$:
$3x - 6 = 2x + 10 + 7 \Rightarrow 3x - 6 = 2x + 17 \Rightarrow x = 23$
...
$a=2, b=-5, c=-3$; discriminant $= (-5)^2 - 4(2)(-3) = 25 + 24 = 49$
$x = \frac{5 \pm 7}{4} \Rightarrow x = 3$ or $x = -\frac{1}{2}$
...
Let $\frac{5x+1}{(x-1)(x+2)} = \frac{A}{x-1} + \frac{B}{x+2}$
$\Rightarrow 5x+1 = A(x+2) + B(x-1)$
Set $x=1$: $6 = A(3) \Rightarrow A = 2$
Set $x=-2$: $-9 = B(-3) \Rightarrow B = 3$
$\Rightarrow \dfrac{5x+1}{(x-1)(x+2)} = \dfrac{2}{x-1} + \dfrac{3}{x+2}$
...
By elimination: Multiply second equation by 3: $12x - 3y = 15$
Add to first equation: $14x = 22 \Rightarrow x = \frac{11}{7}$
Substitute back: $4(\frac{11}{7}) - y = 5 \Rightarrow y = \frac{44}{7} - 5 = \frac{9}{7}$

**Determinants (2×2):**

For $\begin{pmatrix}a & b \\ c & d\end{pmatrix}$, determinant $= ad - bc$
If $ad - bc = 0$, the system has no unique solution (either no solution or infinitely many).
...
Since $a^x = b \Leftrightarrow \log_a b = x$:
