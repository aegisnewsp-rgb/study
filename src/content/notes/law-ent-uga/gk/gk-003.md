...
The NRM government's 1986 assumption of power led to a "no-party" system justified under the "move to party politics" theory. The 1995 Constitution established a formal legal framework for this transition while initially retaining restrictions on party political activity. The 2005 constitutional amendments subsequently restored multiparty politics (removing Articles 269-274 on political parties) and lifted presidential term limits (removing the two-term cap in Article 105).
...
- Constitutional supremacy (Article 2) forms the ultimate legal authority in Uganda, invalidating any inconsistent custom or statutory enactment
