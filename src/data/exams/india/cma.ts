...
const exam: ExamTemplate = {
  ...
  examPattern: `As notified by the Institute of Cost Accountants of India (ICMAI https://icmai.in), the CMA Foundation examination consists of four papers (each carrying 100 marks) conducted in two sessions of 3 hours each. Session I covers Fundamentals of Economics & Management and Fundamentals of Accounting; Session II covers Fundamentals of Law & Ethics and Business Mathematics & Statistics. In the official ICMAI examination regulations (https://icmai.in), candidates must secure a minimum of 40% marks in each individual paper and an aggregate of 50% across all four papers to pass.`,
