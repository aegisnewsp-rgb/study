...
const mathematics: Subject = {
  ...
  topics: [
    ...
    { id: 'math-006', name: 'Differentiability', weight: 4 , description: 'Relationship between continuity and differentiability, Rolle\'s and Lagrange\'s mean value theorems, and derivative as a rate measure.' },
    ...
    { id: 'math-008', name: 'AOD', weight: 5 , description: 'Application of derivatives — equations of tangent and normal, finding maxima and minima, monotonicity, and optimisation problems.' },
    { id: 'math-009', name: 'Indefinite Integrals', weight: 4 , description: 'Integration as antiderivative, standard integration formulas, substitution method, partial fractions, and integration by parts.' },
    { id: 'math-010', name: 'Definite Integrals', weight: 4 , description: 'Definite integrals, properties of definite integrals, Leibniz rule, area under curves, and evaluation using fundamental theorem of calculus.' },
    { id: 'math-011', name: 'DE', weight: 3 , description: 'Formation and solution of differential equations, variable separable, homogeneous and linear differential equations of first and second order.' },
    { id: 'math-012', name: 'Vector Algebra', weight: 4 , description: 'Vector operations — addition, scalar multiplication, dot product, cross product, scalar triple product, and section formula in 3D.' },
    ...
    { id: 'math-015', name: 'Permutations', weight: 3 , description: 'Fundamental principle of counting, permutations of distinct and identical objects, circular permutations, and derangements.' },
    ...
    { id: 'math-017', name: 'Sequences', weight: 4 , description: 'Arithmetic and geometric progressions — nth term, sum of n terms, means, and special series including squares and cubes of natural numbers.' },
