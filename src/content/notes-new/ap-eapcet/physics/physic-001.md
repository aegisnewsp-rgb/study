...
Core concept: Topic 1 is an important topic in ('physics', 'Physics') for AP EAPCET
...
Overview: Topic 1 is a key ('physics', 'Physics') topic for AP EAPCET
...
Full coverage: Topic 1 in ('physics', 'Physics') for AP EAPCET preparation
