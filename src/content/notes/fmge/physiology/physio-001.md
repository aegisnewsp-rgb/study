...
**Cell Physiology and Membrane Transport** — Key Facts for FMGE
Core concept: Cells maintain ionic gradients via Na/K ATPase and transport substances across membranes via various mechanisms
High-yield point: Primary active transport uses ATP directly; secondary active transport uses ionic gradients; facilitated diffusion and channels are passive
⚡ Exam tip: Understand how the Na/K ATPase creates the basis for secondary active transport and how each transporter type is different
...
**Cell Physiology and Membrane Transport** — FMGE Study Guide
