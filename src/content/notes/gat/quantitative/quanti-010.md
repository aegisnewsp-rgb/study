...
$$a^2 + b^2 = c^2 \text{ (where c is hypotenuse)}$$
...
⚡ **GAT PYQ**: "A ladder 25 m long leans against a wall. If foot is 7m
from wall, how far up the wall does it reach?" → Answer: 24 m (7-24-25 triple)
...
**Rhombus Area**: (d₁ × d₂)/2 (where d = diagonals)
...
⚡ **GAT Strategy**: For geometry problems, draw a diagram. Many students lose marks by trying to solve problems mentally!
