...
topic: scienc-014
topicName: "Environmental Ecology and Ecosystem Dynamics"
weight: 3
country: srilanka
...
⚡ **A/L PYQ**: "Explain how energy flows through an ecosystem using the 10% rule"
Answer: Energy is transferred from producers to consumers, with only ~10% passed to each successive level. 90% is lost as heat through respiration, meaning tertiary consumers receive very little energy.
