...
Core concept: Topic 5 is an important topic in ('physics', 'Physics') for Gaokao (China)
...
Overview: Topic 5 is a key ('physics', 'Physics') topic for Gaokao (China)
...
Full coverage: Topic 5 in ('physics', 'Physics') for Gaokao (China) preparation
