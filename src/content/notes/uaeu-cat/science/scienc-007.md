...
subjectName: Science
topic: scienc-007
topicName: The Scientific Method Framework
weight: 3
country: uae
...
**Prompt 1 (Quantitative):** A 2 kg cart is pushed with 10 N across frictionless rails. Using **F = m × a**, find acceleration, then compute **KE** at **v = 3 m/s**.
*Answer:* a = 10/2 = 5 m/s²; KE = ½ × 2 × 9 = 9 J.

**Prompt 2 (Conceptual):** A student drops a feather and a stone in a vacuum. Which hits the ground first and why?
*Answer:* Both hit simultaneously, because gravitational acceleration is independent of mass in the absence of air resistance.
...
- **[View this topic in your UAE University CAT roadmap](/roadmap/?exam=uaeu-cat&duration=1mo)** — see where "Topic 7" fits in your personalised plan
