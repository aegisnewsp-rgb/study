...
Core concept: Topic 4 is an important topic in ('physics', 'Physics') for JIPMER
...
Overview: Topic 4 is a key ('physics', 'Physics') topic for JIPMER
...
Full coverage: Topic 4 in ('physics', 'Physics') for JIPMER preparation
