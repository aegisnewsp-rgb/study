...
Core concept: Topic 14 is an important topic in ('physics', 'Physics') for ECAT (Engineering)
...
Overview: Topic 14 is a key ('physics', 'Physics') topic for ECAT (Engineering)
...
Full coverage: Topic 14 in ('physics', 'Physics') for ECAT (Engineering) preparation
