...
topic: math-5
topicName: Algebraic Expressions and Simple Equations
weight: 5
country: nigeria
generated: "2026-03-24T08:32:07.581571"
diagramPrompt: "Mathematical diagram showing Algebraic Expressions and Simple Equations concept with coordinate axes, labeled points, geometric shapes shaded appropriately, clean black and white style"
...
$3x + 5x = 8x$
$7y - 2y = 5y$
$4x + 3y$ cannot be combined (different variables)
...
1. **Isolate the term with the variable** — remove constants from the left side
   $3x + 7 - 7 = 22 - 7$
   $3x = 15$
...
$2(x + 3) = 16$
Divide both sides by 2 first: $x + 3 = 8$
Then: $x = 5$
...
Let $x$ = number of sweets Chidi has
$x + 8 = 25$
$x = 25 - 8$
$x = 17$
...
Substitute into equation 2: $(7 - y) - y = 3$
$7 - 2y = 3$
$-2y = -4$
$y = 2$
