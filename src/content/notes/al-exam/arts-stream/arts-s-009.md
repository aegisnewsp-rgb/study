...
| Element | Description | Example |
|---------|-------------|---------|
| **P**oint | Main idea of paragraph | "First, many students lack adequate career information" |
| **E**vidence | Supporting material | Statistics, examples, quotes |
| **E**xplanation | How evidence supports point | "According to a 2023 survey by the Education Ministry, 68% of students..." |
| **L**ink | Connect to thesis | "This shows the urgent need for structured guidance programs" |
