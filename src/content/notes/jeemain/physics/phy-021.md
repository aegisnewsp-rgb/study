...
**Historical note**: Nikola Tesla's polyphase AC system (patented in 1887–1888 and licensed by George Westinghouse) was showcased on a grand scale when Westinghouse lit the 1893 World's Columbian Exposition in Chicago with over 100,000 incandescent lamps powered by large AC polyphase generators. The "War of Currents" between Tesla's AC system and Edison's DC system was ultimately won by AC, because AC could be transmitted over long distances at high voltage (low loss) and easily transformed to different voltages using transformers — the foundation of the modern electrical grid.
