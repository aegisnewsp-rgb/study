...
Core concept: Topic 3 is an important topic in ('english', 'English') for UPPM Medicine (Malaysia)
...
Overview: Topic 3 is a key ('english', 'English') topic for UPPM Medicine (Malaysia)
...
Full coverage: Topic 3 in ('english', 'English') for UPPM Medicine (Malaysia) preparation
