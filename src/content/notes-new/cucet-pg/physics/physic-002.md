...
Core concept: Topic 2 is an important topic in ('physics', 'Physics') for CUCET (PG)
...
Overview: Topic 2 is a key ('physics', 'Physics') topic for CUCET (PG)
...
Full coverage: Topic 2 in ('physics', 'Physics') for CUCET (PG) preparation
