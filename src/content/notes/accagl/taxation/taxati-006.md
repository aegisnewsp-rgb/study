...
topic: taxati-006
topicName: "Tax Administration & Returns"
weight: 3
country: pakistan
...
**Tax Administration & Returns** — Key ACCA/CA Pakistan Facts
...
**Tax Administration & Returns** — ACCA/CA Pakistan Study Guide

#### 1. Tax Administration Framework

**Federal Board of Revenue (FBR):**
The FBR is the apex body for federal tax administration. It operates through:
...
Each province has its own revenue authority for provincial taxes (e.g., Punjab Revenue Authority — PRA). Income tax is federal.
...
|---------------|----------|
| Individuals, AOPs | 30 September of the following tax year |
| Companies | 31 December of the following tax year |
| With audit requirement | As per extended timeline notified by FBR |
...
**Audit (Section 121–124):**
The Commissioner may select a return for audit based on:
...
**Amended Assessment:**
After audit, the Commissioner may:
...
Advance tax is payable if the estimated tax liability for the year exceeds **PKR 40,000**.
...
The advance tax is based on the **previous year's tax liability** (or the current year's estimate if higher). For first-year taxpayers with no prior year liability, advance tax may be based on the current year's projected income.
...
**Tax Administration & Returns** — Comprehensive ACCA/CA Pakistan Notes

#### 1. Detailed Tax Administration Structure

**FBR — Organizational Framework:**
The FBR operates under the **Ministry of Finance** and is headed by a Chairman. The IRS (Inland Revenue Service) cadre officers man the positions of Commissioners, Additional Commissioners, Deputy Commissioners, and Assistant Commissioners.
...
**Books and Documents:**
Every person engaged in business or profession must maintain:
...
If a person fails to maintain proper records, the Commissioner may:
...
**E-Filing Portal ( iris.org.pk):**
The FBR's e-filing system (IRIS) is the primary platform for:
- Filing income tax returns
- Paying taxes online
- Viewing tax records and demand notices
- Filing appeals and applications

**Digital Certificate of Tax Payment:**
After paying any tax (advance tax, self-assessment tax, withholding tax), the taxpayer receives a **challan copy** with a unique deposit reference number. This must be quoted in the return to claim credit for taxes paid.
...
**Scope:**
Advance tax applies to **every person** who has a tax liability exceeding PKR 40,000 for the year — whether individual, company, or AOP.
...
The advance tax is payable in four equal installments. The due dates are:
...
**Adjustment Against Final Tax:**
Advance tax paid during the year is adjustable against the final tax liability disclosed in the annual return. If advance tax exceeds the final liability, the excess is **refundable**.

**Default Penalty:**
If advance tax installments are not paid on time, a **default surcharge** of **12% per annum** is levied on the unpaid amount from the due date until payment.

#### 5. Refunds — Section 170

**Claiming Refunds:**
If the tax paid/withheld exceeds the tax liability, the excess is a **refund**. Refund claims are processed by the Commissioner.
...
Instead of a cash refund, a taxpayer may elect to:
- Carry forward the excess tax as a credit for the next tax year, OR
- Request a refund

#### 6. Appeals and Dispute Resolution

**First Appeal — ATIR (Appellate Tribunal Inland Revenue):**
Any person aggrieved by a Commissioner's order (assessment, penalty, refund denial) may file an appeal with the ATIR within **30 days** of the order.

**Second Appeal — High Court:**
Further appeal on a **question of law** lies to the High Court within **60 days**.

**Alternative Dispute Resolution (ADR) — Section 134A:**
A taxpayer and the Commissioner may jointly refer a dispute to ADR before the appeal is heard. The ADR panel can:
- Annul the order, OR
