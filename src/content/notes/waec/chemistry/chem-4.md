...
**States of Matter and Gas Laws** — Key Facts for WAEC WASSCE
...
**States of Matter and Gas Laws** — WAEC WASSCE Chemistry Study Guide
...
In a mixture of non-reacting gases, the total pressure is the sum of the individual partial pressures:
...
**States of Matter and Gas Laws** — Comprehensive WAEC Chemistry Notes

**Derivation of the Ideal Gas Equation**

From Boyle's Law: $V \propto 1/P$ (at constant $T, n$)
From Charles' Law: $V \propto T$ (at constant $P, n$)
From Avogadro's Law: $V \propto n$ (at constant $T, P$)
...
From kinetic theory, the rate of diffusion $r$ is proportional to the average speed $\bar{v}$ and inversely proportional to $\sqrt{M}$:
...
At high pressure (small volume): $P_{\text{ideal}} \approx P + \frac{an^2}{V^2}$ (pressure correction)
At low pressure (large volume): behaviour approaches ideal gas.
...
$P = 750/760 = 0.987$ atm
$V = 1.5$ dm³
$n = PV/RT = (0.987 \times 1.5)/(0.0821 \times 300) = 1.4805/24.63 = 0.0601$ mol
