...
Core concept: Topic 7 is an important topic in ('physics', 'Physics') for ECAT (Engineering)
...
Overview: Topic 7 is a key ('physics', 'Physics') topic for ECAT (Engineering)
...
Full coverage: Topic 7 in ('physics', 'Physics') for ECAT (Engineering) preparation
