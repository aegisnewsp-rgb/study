...
subjectName: Biology
topic: bio-7
topicName: "Transport: Circulatory System"
weight: 5
country: nigeria
...
Superior/inferior vena cava → Right atrium → Tricuspid valve → Right ventricle → Pulmonary valve → Pulmonary artery → Lungs → Pulmonary veins → Left atrium → Bicuspid (mitral) valve → Left ventricle → Aortic valve → Aorta → Body
...
Vitamin K is needed for prothrombin synthesis.
...
Systolic pressure: Maximum during ventricular systole (~120 mmHg)
Diastolic pressure: Minimum during ventricular diastole (~80 mmHg)
