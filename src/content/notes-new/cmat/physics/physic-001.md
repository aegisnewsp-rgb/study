...
Core concept: Topic 1 is an important topic in ('physics', 'Physics') for CMAT Nepal
...
Overview: Topic 1 is a key ('physics', 'Physics') topic for CMAT Nepal
...
Full coverage: Topic 1 in ('physics', 'Physics') for CMAT Nepal preparation
