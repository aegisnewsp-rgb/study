...
topic: indian-001
topicName: Constitutional Framework and Key Articles
weight: 3
country: india
...
- Has NO executive or judicial powers — purely advisory
-Jurisdiction is limited to state-state disputes only — NOT Union-state disputes
...
1. The most frequently tested trap: Students write "India is a federation" — correct answer is "India is a Union of States with federal features." The distinction is frequently asked in RAS Main examination.
2. Article 3 vs. Article 2: If a question asks about creating a new state from an existing state — it's Article 3. If asking about admitting a territory that was previously outside India — Article 2.
3. Fifth vs. Sixth Schedule: Fifth Schedule is for tribal areas in non-northeastern states; Sixth Schedule is for northeastern states with district councils. Do not confuse them — they cover different territories and have different degrees of autonomy.
