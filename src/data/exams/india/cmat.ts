...
const exam: ExamTemplate = {
  ...
  examPattern: `As notified by the National Testing Agency (NTA https://exams.nta.ac.in/CMAT), the Common Management Admission Test (CMAT) consists of 100 multiple-choice questions across 5 sections (Quantitative Techniques & Data Interpretation, Logical Reasoning, Language Comprehension, General Awareness, and Innovation & Entrepreneurship; 20 questions each, 400 marks total) with a duration of 3 hours (180 minutes). In the official NTA marking scheme, each correct answer receives 4 marks, while 1 mark is deducted for each incorrect answer.`,
  eligibility: `Per official NTA information bulletins (https://exams.nta.ac.in/CMAT), candidates must hold a Bachelor's degree in any discipline from a recognized university. Candidates appearing for the final year of their Bachelor's degree whose results will be declared before commencement of admission are also eligible to apply. There is no age restriction for appearing in CMAT.`,
  subjects,
    durations: {
