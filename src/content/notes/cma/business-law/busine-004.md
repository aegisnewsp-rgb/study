...
|---|---|---|---|
| Nature | Promise to pay | Order to pay | Order to bank |
| Parties | Maker + Payee (2) | Drawer + Drawee + Payee (3) | Drawer + Drawee/Bank + Payee (3) |
| Acceptance | Not required | Required | Not required (bank is drawee) |
| Days of Grace | Applicable | Applicable | Not applicable |
| Crossing | Optional | Optional | Common but not mandatory |
| Sec 138 liability | No | No | Yes (criminal) |
...
#### Accommodation Bill — Special Legal Position
