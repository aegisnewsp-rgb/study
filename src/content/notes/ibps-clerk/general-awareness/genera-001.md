...
| Instrument | Description | Current Rate (approx.) |
|---|---|---|
| Repo Rate | Rate at which RBI lends to banks (overnight) | 6.50% |
...
| CRR (Cash Reserve Ratio) | % of NDTL banks must maintain with RBI | 4.50% |
| SLR (Statutory Liquidity Ratio) | % of NDTL banks must invest in govt securities | 18.00% |
