...
const exam: ExamTemplate = {
  ...
  examPattern: `The BPSC Preliminary Examination consists of a single General Studies paper with 150 multiple-choice questions carrying 150 marks (2 hours duration). Negative marking is 1/3 mark (-0.33) per incorrect answer. The Main Examination typically comprises five papers: General Hindi (100 marks, qualifying at 30%), General Studies Paper 1 (300 marks), General Studies Paper 2 (300 marks), Essay Paper (300 marks), and an Optional Subject paper (100 marks, qualifying MCQ format). The final merit list is typically determined by marks in GS Paper 1, GS Paper 2, Essay (900 marks total), plus the Interview (120 marks), totalling 1020 marks.`,
  eligibility: `Candidates must be Indian citizens holding a bachelor's degree in any discipline from a recognized university. Minimum age ranges between 20, 21, or 22 years depending on the specific service post (20 for DSP/Prison, 21 for Administrative/Finance, 22 for others) as of 1 August of the exam year. Maximum age limits are typically 37 years for General (Male), 40 years for General (Female) and BC/EBC (Male & Female), and 42 years for SC/ST (Male & Female). Physical measurements apply for Bihar Police Service posts (minimum height 5 feet 5 inches for General/BC males).`,
  subjects,
    durations: {
