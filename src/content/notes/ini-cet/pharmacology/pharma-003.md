...
topic: pharma-003
topicName: "Pharmacodynamics and Receptor Mechanisms"
weight: 3
country: india
...
| Type | Intrinsic activity (α) | Behaviour |
| --- | --- | --- |
| Full agonist | 1 | Produces Emax |
| Partial agonist | 0 < α < 1 | Lower Emax; antagonizes a full agonist |
| Inverse agonist | Negative | Produces effect opposite to agonist (requires constitutive receptor activity) |
| Competitive antagonist | 0 | Parallel right shift, Emax preserved |
| Non-competitive antagonist | 0 | Reduces Emax, curve flattened |
...
- **[View this topic in your INI CET (AIIMS PG) roadmap](/roadmap/?exam=ini-cet&duration=1mo)** — see where "Topic 3" fits in your personalised plan
