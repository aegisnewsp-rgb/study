...
topic: genera-007
topicName: "Indian Economy — Key Concepts & Macroeconomic Indicators"
weight: 3
country: india
...
GDP = C + I + G + (X – M)
Where: C = Private Consumption; I = Gross Investment; G = Government Spending; X = Exports; M = Imports
...
**GVA (Gross Value Added):** Measures contribution of each sector to GDP at basic prices.
