...
Core concept: Topic 14 is an important topic in ('physics', 'Physics') for EGE (Russia)
...
Overview: Topic 14 is a key ('physics', 'Physics') topic for EGE (Russia)
...
Full coverage: Topic 14 in ('physics', 'Physics') for EGE (Russia) preparation
