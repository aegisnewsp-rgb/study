...
Core concept: Topic 9 is an important topic in ('chemistry', 'Chemistry') for EGE (Russia)
...
Overview: Topic 9 is a key ('chemistry', 'Chemistry') topic for EGE (Russia)
...
Full coverage: Topic 9 in ('chemistry', 'Chemistry') for EGE (Russia) preparation
