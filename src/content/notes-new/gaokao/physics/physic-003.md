...
Core concept: Topic 3 is an important topic in ('physics', 'Physics') for Gaokao (China)
...
Overview: Topic 3 is a key ('physics', 'Physics') topic for Gaokao (China)
...
Full coverage: Topic 3 in ('physics', 'Physics') for Gaokao (China) preparation
