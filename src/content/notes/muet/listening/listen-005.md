...
1. Read ALL questions in the task (30 seconds)
2. Identify the specific information type for each question — number, name, opinion, reason (20 seconds)
3. Underline key words in each question (20 seconds)
4. Predict the topic vocabulary based on context clues (20 seconds)

**For Tasks 3 and 4 (play twice):**
1. Read the questions and identify topic/setting (30 seconds)
2. Note any complex questions that need extra attention (30 seconds)
3. Decide what to focus on in each listening pass (30 seconds)
