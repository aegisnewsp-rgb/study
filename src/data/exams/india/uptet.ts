...
const exam: ExamTemplate = {
  ...
  examPattern: 'Paper I (for Classes I-V): 150 MCQ questions of 1 mark each covering Child Development & Pedagogy (30), Language I — Hindi (30), Language II — English/Urdu/Sanskrit (30), and Mathematics & Environmental Studies (30+30). Paper II (for Classes VI-VIII): 150 MCQ questions covering Child Development & Pedagogy (30), Language I — Hindi (30), Language II — English/Urdu/Sanskrit (30), and Science & Social Studies (30+30) OR Mathematics & Science (60) for Mathematics teachers. Each paper is of 150 marks with a duration of 2 hours 30 minutes. There is no negative marking. As notified by the Uttar Pradesh Basic Education Board (https://updeled.gov.in), candidates must score at least 60% (90 marks out of 150) to qualify, with a relaxed threshold of 55% (82 marks) for SC, ST, and OBC reserved categories.',
