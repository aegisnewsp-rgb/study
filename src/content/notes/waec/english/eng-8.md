...
weight: 4
country: nigeria
generated: "2026-03-24T08:32:07.612109"
...
**Word Formation:**
English builds words through affixation (adding prefixes/suffixes), compounding, and conversion (changing word class without changing form).
...
"The farmer planted maize in the field last Saturday."
(S=farmer, V=planted, O=maize, Adv=in the field, Adv=last Saturday)

**Sentence Transformation in WAEC:**
The WAEC paper frequently requires you to rewrite sentences without changing the meaning:
...
Synonyms are words with the same or nearly the same meaning (e.g., happy/glad/joyful). Antonyms are words with opposite meanings (e.g., hot/cold, accept/reject). WAEC tests your ability to identify the most appropriate synonym in context — not just any synonym, but the one that fits the sentence stylistically and semantically.

**Denotation vs. Connotation:**
- Denotation: the literal dictionary meaning
- Connotation: the emotional or cultural associations
  "Slim" and "skinny" are synonyms denotatively, but "skinny" carries a negative connotation in most contexts.
...
Understanding morphemes (the smallest meaningful units) helps with unfamiliar words:
...
**1. Vocabulary in Context (Objective Test — Paper 1):**
"By the time the rescue team arrived, the fire had already done ___ damage to the building."
Options: (a) unspeakable (b) unshakeable (c) unaccountable (d) unavailability
Answer: (a) — unspeakable (cannot be expressed in words, implying immense damage). "Unspeakable damage" is a collocation.

**2. Sentence Transformation (Paper 2 — Essay/Structure):**
Direct: "The teacher said, 'Submit your assignments tomorrow.'"
Indirect: The teacher said we should/must submit our assignments the following day.

**3. Word Formation (Gap Fill):**
"The judge's ___ decision was praised by all." (JUSTIFY → "just" is the root → JUST)
Answer: "just" → the base word is "just," and the suffix "-ify" creates "justif-y"
...
1. In multiple-choice Lexis questions, cover the options and read the sentence with the blank. Ask yourself: "What kind of word goes here?" — then look for the option that matches your prediction.
2. For collocation questions, trust your instinct — if "heavy rain" sounds right, it probably is. Avoid overthinking.
3. In sentence transformation questions, keep the meaning exactly the same. Only the grammatical form should change.
4. For word formation, identify the root word first, then determine which suffix or prefix produces the correct word class and meaning.
5. In error-spotting questions, read the entire sentence to identify what the intended meaning is, then locate the specific word or phrase that contradicts that meaning.
