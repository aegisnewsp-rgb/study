...
**1. Gradable Antonyms:**
Exist on a sliding scale — there are degrees between the opposites.
...
**2. Complementary (Contradictory) Antonyms:**
Either one is true or the other — no middle ground.
...
Opposites that exist only in relation to each other.
...
**1. UN- (Most Common):**
Attaches to adjectives, verbs, and some nouns:
- Known → Unknown
- Fair → Unfair
- Lock → Unlock
- Dress → Undress
...
**2. DIS- (Action Reversal / Negation):**
Usually verbs and nouns, sometimes adjectives:
- Appear → Disappear
- Like → Dislike
- Honesty → Dishonesty
- Trust → Distrust
...
**3. IN-/IM-/IL-/IR- (Latinate Negation):**
The spelling changes based on the following letter:
...
**Example:**
"The weather was **cold**, **but** the children still went outside to play."
→ Cold is the opposite of hot (or warm), but in context the key is that they played despite the cold conditions.

**NCEE Antonym Question Strategies:**

1. **Read the entire sentence** — context reveals the needed word
2. **Identify the target word** — what does it mean?
3. **Eliminate obvious synonyms** — if options include synonyms, they are wrong
4. **Look for the prefix** — many antonyms use common negative prefixes
5. **Check grammar** — the antonym must be the same part of speech

**Example NCEE Question:**
"Choose the word that is most nearly opposite in meaning to **gentle**:"
A) Soft
B) Rough
C) Kind
D) Mild
