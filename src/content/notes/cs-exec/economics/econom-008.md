...
## Short-Run Cost Curves: Key Definitions
...
## The Nature of Costs: Economic vs. Accounting Perspective
...
**Economic Profit** = TR – (Explicit Costs + Implicit Costs) = Accounting Profit – Implicit Costs
...
**Average Cost (AC) falls when Marginal Cost (MC) is below it.**
**Average Cost (AC) rises when Marginal Cost (MC) is above it.**
**AC is at its minimum when MC = AC.**
...
**AVC falls when MC is below it.**
**AVC rises when MC is above it.**
**AVC is at its minimum when MC = AVC.**
...
These sensitivities can be expressed as:
**% change in BEP / % change in parameter**
...
If make cost < buy cost (including opportunity costs) → **Make**
If buy cost < make cost → **Buy**
