...
A set of 5-6 sentences in jumbled order. Your task is to arrange them into a coherent paragraph. In CAT, you encounter 3-4 such sets per paper.
...
- Contains words like "therefore," "thus," "hence," "in conclusion," "as a result"
- References a future implication or recommendation
...
⚡ **Common Student Mistake:** Relying only on transition words without checking logical coherence. Some sentences use transition words without a true logical connection — always verify the underlying relationship.
...
- C: "The company expanded into electronics and cloud computing."
...
In a well-structured paragraph, the subject of one sentence becomes the object of the next sentence's action, or the next sentence explains what happened to the subject.

**Working with Different Passage Types:**

**Narrative (Historical/Story):**
- Chronological order is key
...
E. "This discovery will revolutionise treatment for depression and anxiety."
...
⚡ **Exam Strategy:** In the actual exam, with time pressure, look for the most distinctive sentence (notably the opening) and the clearest closing signal. For middle sentences, the transition word is the definitive tiebreaker. If no transition word exists, fall back to subject continuity.