// SAT Math — College Board digital SAT (Qatar).
// Awarding body: College Board. Two modules of 22 questions (operational +
// pretest), 35 minutes per module, 70 minutes total. Topics are the four
// published Math "content domains" of the digital SAT (Heart of Algebra,
// Problem Solving and Data Analysis, Passport to Advanced Math, and Geometry
// and Trigonometry). In Qatar the test is administered by the British Council
// at its Doha test centre as part of the College Board international test
// centre network, and at approved international school test sites in Doha.
// A calculator is permitted for the entire Math section, and an on-screen
// calculator is provided. Source: The Digital SAT Suite of Assessments
