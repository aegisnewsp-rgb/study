...
const DUR_MAP: Record<string, {days: number; desc: string}> = {
  ...
  '6mo': { days: 180, desc: 'Six-month plan — a first pass over the syllabus for 8 weeks, a second pass for 10 weeks, then a revision pass over the final 6 weeks.' },
