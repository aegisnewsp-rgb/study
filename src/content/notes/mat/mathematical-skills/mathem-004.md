...
topic: mathem-004
topicName: Percentages and Profit-Loss
weight: 3
country: mat
...
When a quantity changes by $x\%$ then by $y\%$, the final value = original × (1 + x/100) × (1 + y/100)

⚡ **MAT Shortcut**: For successive increases of $a\%$, $b\%$, $c\%$, total = $(1 + a/100)(1 + b/100)(1 + c/100) - 1$, expressed as percentage.

Example: A number increases by 20%, then decreases by 10%.
Final = $100 \times 1.20 \times 0.90 = 108$
Net increase = 8% (NOT 10%!)
...
**Compound Interest**: $A = P \times (1 + R/100)^T$
...
Let CP = $x$. Original SP = $1.2x$
New CP = $0.9x$
New SP = $1.2x - 5$

Profit = $\frac{1.2x - 5 - 0.9x}{0.9x} \times 100 = 25\%$
$\frac{0.3x - 5}{0.9x} = 0.25$
$0.3x - 5 = 0.225x$
$0.075x = 5$
$x = \frac{5}{0.075} = 66.67$
...
⚡ **MAT PYQ**: If the difference between CI and SI on a sum at 10% per annum for 2 years is Rs 25, find the sum.
Solution: $P \times (10/100)^2 = 25$ → $P \times 0.01 = 25$ → $P = 2500$
...
⚡ **Single Equivalent Discount**: Two discounts $d_1\%$ and $d_2\%$:
Equivalent = $1 - (1-d_1/100)(1-d_2/100)$
For 20% and 10% off: $1 - 0.80 \times 0.90 = 1 - 0.72 = 28\%$ (NOT 30%!)
