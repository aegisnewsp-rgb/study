...
**If P₁ persons can do W₁ work in D₁ days working t₁ hours per day**
**And P₂ persons can do W₂ work in D₂ days working t₂ hours per day**
...
Time taken together = T days
A's work in T days = T/a
B's work in T days = T/b
T/a + T/b = 1
T(1/a + 1/b) = 1
T = 1/(1/a + 1/b) = ab/(a+b)
...
**With Leak**:
Example: A fill pipe fills in 10 hrs. There's a leak that empties full tank in 20 hrs. How long to fill empty tank?
- Fill rate = 1/10
