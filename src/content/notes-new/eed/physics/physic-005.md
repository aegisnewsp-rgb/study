...
Core concept: Topic 5 is an important topic in ('physics', 'Physics') for EGE (Russia)
...
Overview: Topic 5 is a key ('physics', 'Physics') topic for EGE (Russia)
...
Full coverage: Topic 5 in ('physics', 'Physics') for EGE (Russia) preparation
