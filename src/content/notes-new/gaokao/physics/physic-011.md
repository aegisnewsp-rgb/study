...
Core concept: Topic 11 is an important topic in ('physics', 'Physics') for Gaokao (China)
...
Overview: Topic 11 is a key ('physics', 'Physics') topic for Gaokao (China)
...
Full coverage: Topic 11 in ('physics', 'Physics') for Gaokao (China) preparation
