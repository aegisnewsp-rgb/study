...
Core concept: Topic 2 is an important topic in ('english', 'English') for CUCET (PG)
...
Overview: Topic 2 is a key ('english', 'English') topic for CUCET (PG)
...
Full coverage: Topic 2 in ('english', 'English') for CUCET (PG) preparation
