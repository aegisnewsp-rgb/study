...
Core concept: Topic 7 is an important topic in ('physics', 'Physics') for BITSAT
...
Overview: Topic 7 is a key ('physics', 'Physics') topic for BITSAT
...
Full coverage: Topic 7 in ('physics', 'Physics') for BITSAT preparation
