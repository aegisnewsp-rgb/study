export const hindi: Subject = {
  ...
  topics: [
    ...
    { id: 'hindi-006', name: 'Topic 6', weight: 3 as const, description: 'Hindi Literature — prose and poetry: Important prose writers and poets in Hindi literature, their works and literary contributions — content knowledge for language teaching.' },
    { id: 'hindi-007', name: 'Topic 7', weight: 3 as const, description: 'Unseen Passage and Comprehension: Reading comprehension techniques for Hindi passages, question types, and answering strategies — assessment skills for teachers.' },
    { id: 'hindi-008', name: 'Topic 8', weight: 3 as const, description: 'Hindi Bhasha — Guna and Vriddhi: Guna-aadesha (ara, ali) and vriddhi-aadesha (aadesha, gyaan), their applications in word formation — classical Hindi grammar rules.' }
  ]
};
