...
const exam: ExamTemplate = {
  ...
  eligibility: 'No formal prerequisites - candidates register through the British Council (https://takeielts.britishcouncil.org/) or IDP (https://www.ielts.org/) at an approved test centre. In Qatar, candidates typically register through the British Council Doha or IDP IELTS Doha. There is no minimum age (candidates under 16 require parental consent in some centres); there is no cap on retakes; ID document on test day is mandatory (passport or Qatar ID for residents). Special arrangements (extra time, enlarged print) are available with documented evidence applied for in advance.',
  subjects,
  durations: {
    '1h': makeRoadmap(subjects, '1h', 1, 'Study plan for IELTS (Qatar) — 1 Hour'),
    '2h': makeRoadmap(subjects, '2h', 1, 'Study plan for IELTS (Qatar) — 2 Hours'),
    '3h': makeRoadmap(subjects, '3h', 1, 'Study plan for IELTS (Qatar) — 3 Hours'),
    '5h': makeRoadmap(subjects, '5h', 1, 'Study plan for IELTS (Qatar) — 5 Hours'),
    '12h': makeRoadmap(subjects, '12h', 1, 'Study plan for IELTS (Qatar) — 12 Hours'),
    '1d': makeRoadmap(subjects, '1d', 1, 'Study plan for IELTS (Qatar) — 1 Day'),
    '2d': makeRoadmap(subjects, '2d', 2, 'Study plan for IELTS (Qatar) — 2 Days'),
    '3d': makeRoadmap(subjects, '3d', 3, 'Study plan for IELTS (Qatar) — 3 Days'),
    '5d': makeRoadmap(subjects, '5d', 5, 'Study plan for IELTS (Qatar) — 5 Days'),
    '7d': makeRoadmap(subjects, '7d', 7, 'Study plan for IELTS (Qatar) — 1 Week'),
    '10d': makeRoadmap(subjects, '10d', 10, 'Study plan for IELTS (Qatar) — 10 Days'),
    '2w': makeRoadmap(subjects, '2w', 14, 'Study plan for IELTS (Qatar) — 2 Weeks'),
    '1mo': makeRoadmap(subjects, '1mo', 30, 'Study plan for IELTS (Qatar) — 1 Month'),
    '2mo': makeRoadmap(subjects, '2mo', 60, 'Study plan for IELTS (Qatar) — 2 Months'),
    '3mo': makeRoadmap(subjects, '3mo', 90, 'Study plan for IELTS (Qatar) — 3 Months'),
    '6mo': makeRoadmap(subjects, '6mo', 180, 'Study plan for IELTS (Qatar) — 6 Months'),
    '1yr': makeRoadmap(subjects, '1yr', 365, 'Study plan for IELTS (Qatar) — 1 Year'),
    '2yr': makeRoadmap(subjects, '2yr', 730, 'Study plan for IELTS (Qatar) — 2 Years'),
  },
  rescueMode: {
    name: 'Rescue Mode',
    description: 'Cramming plan for IELTS (Qatar)',
    duration: '1d',
    focusAreas: [
  ...
  commonMistakes: [
    ...
    'Failing to check the computer-delivered vs paper-based option at the chosen test centre in Doha — keyboard fluency and the lack of the 10-minute transfer time on computer-delivered tests change the test-day plan.'
  ],
