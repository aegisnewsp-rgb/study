...
const exam: ExamTemplate = {
  ...
  examPattern: 'Administered by the National Examinations Council of Tanzania (NECTA https://necta.go.tz), ACSEE consists of papers including compulsory General Studies plus elective subjects chosen from science, commercial, or arts combinations. Written papers typically have a duration of 3 hours, featuring essay, short answer, and objective questions as specified in the official NECTA examination format.',
  eligibility: 'Per official NECTA regulations (https://necta.go.tz), candidates must hold a valid CSEE (Form IV) certificate having passed at least 4 subjects at credit level. Progression to undergraduate admission is regulated by the Tanzania Commission for Universities (https://tcu.go.tz) based on principal passes and institutional cutoff criteria.',
  subjects,
    durations: {
