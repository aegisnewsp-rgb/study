...
Core concept: Topic 11 is an important topic in ('physics', 'Physics') for ECAT (Engineering)
...
Overview: Topic 11 is a key ('physics', 'Physics') topic for ECAT (Engineering)
...
Full coverage: Topic 11 in ('physics', 'Physics') for ECAT (Engineering) preparation
