...
Core concept: Topic 1 is an important topic in ('physics', 'Physics') for UPSEE
...
Overview: Topic 1 is a key ('physics', 'Physics') topic for UPSEE
...
Full coverage: Topic 1 in ('physics', 'Physics') for UPSEE preparation
