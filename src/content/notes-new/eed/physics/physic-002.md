...
Core concept: Topic 2 is an important topic in ('physics', 'Physics') for EGE (Russia)
...
Overview: Topic 2 is a key ('physics', 'Physics') topic for EGE (Russia)
...
Full coverage: Topic 2 in ('physics', 'Physics') for EGE (Russia) preparation
