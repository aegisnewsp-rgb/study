...
Core concept: Topic 9 is an important topic in ('physics', 'Physics') for ECAT (Engineering)
...
Overview: Topic 9 is a key ('physics', 'Physics') topic for ECAT (Engineering)
...
Full coverage: Topic 9 in ('physics', 'Physics') for ECAT (Engineering) preparation
