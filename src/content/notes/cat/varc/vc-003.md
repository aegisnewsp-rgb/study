...
⚡ **CAT Exam Tip:** The correct answer is almost never the most obvious or the most detailed one. The correct summary is concise and captures the main point without adding new information.
...
In a passage, the central claim appears:
...
- Watch for: "while the study shows X, it does not prove Y" — this nuance is decisive.
...
⚡ **Exam Strategy:** In the final minutes, if stuck between two options, pick the one that is most specific to the passage without introducing external information. Options that "sound smart" by using the passage's own vocabulary are correct.