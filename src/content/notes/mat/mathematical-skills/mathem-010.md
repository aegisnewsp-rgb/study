...
**Weighted Average**: If group 1 has average $a_1$ and $n_1$ items; group 2 has average $a_2$ and $n_2$ items:
...
**Direct proportion**: If more work → more workers (or more days), and vice versa.
**Formula**: $M_1 \times D_1 \times W_2 = M_2 \times D_2 \times W_1$
...
Example: HCF of $\frac{3}{4}$ and $\frac{5}{6}$ = $\frac{\text{HCF}(3,5)}{\text{LCM}(4,6)} = \frac{1}{12}$

#### LCM of Fractions
$$\text{LCM of fractions} = \frac{\text{LCM of numerators}}{\text{HCF of denominators}}$$
Example: LCM of $\frac{3}{4}$ and $\frac{5}{6}$ = $\frac{\text{LCM}(3,5)}{\text{HCF}(4,6)} = \frac{15}{2} = 7.5$
...
If average of n numbers is A, and one number is replaced:
$$\text{New number} = \text{Old number} + n \times (\text{New average} - \text{Old average})$$
