...
Core concept: Topic 9 is an important topic in ('physics', 'Physics') for Gaokao (China)
...
Overview: Topic 9 is a key ('physics', 'Physics') topic for Gaokao (China)
...
Full coverage: Topic 9 in ('physics', 'Physics') for Gaokao (China) preparation
