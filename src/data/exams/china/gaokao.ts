...
const exam: ExamTemplate = {
  ...
  examPattern: '3 mandatory subjects + 1 elective: Chinese Language (150 marks, 150 minutes), Mathematics (150 marks, 120 minutes), English (150 marks, 120 minutes), plus one elective from either Physics/History (Science stream) or Politics/Geography/History (Arts stream). Papers run 120-150 minutes each across two days in June. Science stream includes Physics, Chemistry, Biology; Arts stream includes Politics, History, Geography. Total marks: 750.',
