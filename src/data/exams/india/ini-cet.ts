...
const exam: ExamTemplate = {
  ...
  examPattern: `The INI CET examination consists of 200 multiple-choice questions (MCQs) to be completed in 3 hours (180 minutes), per the scheme of examination notified in the AIIMS INI-CET Prospectus Part-A (docs.aiimsexams.ac.in). The question paper covers all subjects taught during the MBBS programme: Pre-clinical subjects (Anatomy, Physiology, Biochemistry), Para-clinical subjects (Pathology, Pharmacology, Microbiology, Forensic Medicine, Community Medicine), and Clinical subjects (Medicine and its specialties, Surgery and its specialties, Obstetrics and Gynecology, Pediatrics). Each question carries 1 mark, with 1/3 mark deducted for each incorrect answer. The exam is conducted in online (computer-based) mode at designated test centres. The medium of the exam is English. Confirm the live-cycle scheme in the current AIIMS information bulletin before you plan mocks around it.`,
  eligibility: `Candidates must have completed their MBBS degree from an institution recognized by the National Medical Commission (NMC) and must have completed their compulsory rotating internship on or before the date of counselling. For MD/MS programmes, the AIIMS INI-CET Prospectus Part-A (docs.aiimsexams.ac.in) requires a minimum aggregate of 55% across all MBBS professional examinations for General and OBC/EWS categories, and 50% for the SC/ST category (PwBD candidates use the percentage applicable to their own category as notified in the same prospectus). For DM/M.Ch. programmes, candidates must have completed the respective postgraduate degree (MD/MS) and meet the specialty-specific requirements. Foreign nationals require 55% aggregate or equivalent per the same bulletin. Confirm the current cycle's eligibility clauses in the latest AIIMS information bulletin before you apply.`,
  subjects,
    durations: {
