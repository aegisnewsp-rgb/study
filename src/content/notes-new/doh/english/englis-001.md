...
Core concept: Topic 1 is an important topic in ('english', 'English') for DOH (UAE)
...
Overview: Topic 1 is a key ('english', 'English') topic for DOH (UAE)
...
Full coverage: Topic 1 in ('english', 'English') for DOH (UAE) preparation
