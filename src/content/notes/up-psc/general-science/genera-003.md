...
**Laws of Motion and Friction** — Key Facts for UPPSC PCS
Core concept: Newton's three laws form the foundation of classical mechanics; friction opposes relative motion between surfaces
High-yield point: F = ma (Second Law) is the most frequently applied formula in UPPSC physics questions
⚡ Exam tip: Questions on friction (static vs kinetic) and momentum conservation appear almost every year in UPPSC Prelims
