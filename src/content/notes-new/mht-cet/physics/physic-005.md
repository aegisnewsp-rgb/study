...
Core concept: Topic 5 is an important topic in ('physics', 'Physics') for MHT-CET
...
Overview: Topic 5 is a key ('physics', 'Physics') topic for MHT-CET
...
Full coverage: Topic 5 in ('physics', 'Physics') for MHT-CET preparation
