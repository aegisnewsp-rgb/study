const mathematics: Subject = {
  ...
  topics: [
    ...
    { id: 'mathem-013', name: 'Topic 13', weight: 3 as const }
    { id: 'mathem-014', name: 'Topic 14', weight: 3 as const }
    { id: 'mathem-015', name: 'Topic 15', weight: 3 as const }
    { id: 'mathem-016', name: 'Topic 16', weight: 3 as const }
    { id: 'mathem-017', name: 'Topic 17', weight: 3 as const }
    { id: 'mathem-018', name: 'Topic 18', weight: 3 as const }
  ]
};
