...
# Tissue Types and Histology — Epithelium, Connective Tissue, Muscle and Nerve
...
1. **Number of layers:** Simple (single layer) vs Stratified (multiple layers) vs Pseudostratified (single layer but nuclei at different levels — appears multilayered)
2. **Cell shape (apical surface):** Squamous (flat), Cuboidal (cube-shaped), Columnar (tall rectangular)
...
1. **Cells:** Fibroblasts (make fibers), adipocytes (fat cells), macrophages (phagocytosis), plasma cells (antibody secretion), mast cells (histamine, heparin), leukocytes
2. **Fibers:**
...
3. **Ground substance:** Gel-like matrix — proteoglycans, glycoproteins (fibronectin, laminin); gel-like consistency; permits diffusion of nutrients
