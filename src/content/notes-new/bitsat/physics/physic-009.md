...
Core concept: Topic 9 is an important topic in ('physics', 'Physics') for BITSAT
...
Overview: Topic 9 is a key ('physics', 'Physics') topic for BITSAT
...
Full coverage: Topic 9 in ('physics', 'Physics') for BITSAT preparation
