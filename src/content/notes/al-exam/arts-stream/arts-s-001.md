...
| Term | Definition |
|------|-----------|
| Frame narrative | A story that contains other stories |
| Fabliau | A short, comic, often indecent tale |
| Indirect characterisation | Revealing character through description, not direct statement |
| Dramatic irony | Audience knows more than characters |
| Pilgrimage motif | Journey as spiritual quest or social spectacle |
