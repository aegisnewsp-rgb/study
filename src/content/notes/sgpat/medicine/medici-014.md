...
| Product class | Decision rule | GP exam implication |
|---|---|---|
| **Borderline product** | Determined by **intended purpose**, claimed action, and pharmacological/immunological/metabolic profile | Classify before prescribing or advising |
| **Combination product** | Assessed by **primary mode of action** (drug vs. device vs. biologic) | Determines SFDA review pathway |
| **Drug-device combination** | Drug exerts **principal action**, device delivers it | Regulated predominantly as a medicinal product |
...
**Product:** Hyaluronic acid dermal filler supplied in a prefilled syringe with an integrated microneedle applicator.
**Question:** SFDA regulatory category?
...
- **[View this topic in your Saudi GP Board roadmap](/roadmap/?exam=sgpat&duration=1mo)** — see where "Topic 14" fits in your personalised plan
