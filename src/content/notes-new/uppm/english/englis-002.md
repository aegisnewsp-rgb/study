...
Core concept: Topic 2 is an important topic in ('english', 'English') for UPPM Medicine (Malaysia)
...
Overview: Topic 2 is a key ('english', 'English') topic for UPPM Medicine (Malaysia)
...
Full coverage: Topic 2 in ('english', 'English') for UPPM Medicine (Malaysia) preparation
