export const biology: Subject = {
  ...
  topics: [
    ...
    { id: 'biolog-011', name: 'Topic 11', weight: 3 as const },
    { id: 'biolog-012', name: 'Topic 12', weight: 3 as const },
    { id: 'biolog-013', name: 'Topic 13', weight: 3 as const },
    { id: 'biolog-014', name: 'Topic 14', weight: 3 as const },
    { id: 'biolog-015', name: 'Topic 15', weight: 3 as const }
  ]
};
