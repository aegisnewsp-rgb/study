...
subjectName: Science
topic: scienc-009
topicName: Mendelian Foundations
weight: 3
country: philippines
...
#### Practice Prompts
1. Two heterozygous parents for a recessive disease have a child. What is the probability the child is both unaffected and not a carrier?
2. Given mRNA codon AUG, name the tRNA anticodon and the amino acid it carries (methionine, the start codon).
