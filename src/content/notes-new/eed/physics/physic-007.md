...
Core concept: Topic 7 is an important topic in ('physics', 'Physics') for EGE (Russia)
...
Overview: Topic 7 is a key ('physics', 'Physics') topic for EGE (Russia)
...
Full coverage: Topic 7 in ('physics', 'Physics') for EGE (Russia) preparation
