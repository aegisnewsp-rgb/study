...
**Simple and Compound Interest** — Key Facts for NABE (Pakistan)
...
## Simple and Compound Interest — NABE (Pakistan) Study Guide
...
1. Direct SI/CI calculations
2. Finding rate or time when other values are given
3. Comparing SI and CI for same principal and rate
4. Population growth problems (similar to CI)
...
## Simple and Compound Interest — Comprehensive NABE (Pakistan) Notes
...
**Equivalent Formula for Any Period**:
If time is given in months: T = months/12
If time is given in days: T = days/365 (or 360 for commercial calculations)
...
**Example**: Population of a town is 50,000 and grows at 5% per annum. Find population after 4 years.
- P = 50000(1 + 5/100)^4
- P = 50000 × (1.05)^4
...
**Example**: A machine worth Rs. 100,000 depreciates at 10% per year. Find value after 3 years.
- V = 100000(1 - 10/100)^3
...
**Difference Formula**:
For 2 years: Difference = P(R/100)²/10000
For 3 years: Difference = P[(R/100)²(3 + R/100)]/10000
...
```
Installment = P × (1 + R/100)^T × R/100 / [(1 + R/100)^T - 1]
```
...
1. **Time Period Confusion**: Convert months to years properly
2. **Rate Per Period**: Adjust rate when compounding frequency changes
3. **Simple vs. Compound**: Don't mix formulas
4. **Rounding Errors**: Keep more decimals during calculation
5. **Interpreting "Rate"**: Is it per annum or per period?

### Practice Questions for NABE

1. Find the compound interest on Rs. 8000 at 15% per annum for 2 years.
2. The simple interest on a sum for 3 years at 8% is Rs. 720. Find the compound interest for the same period at the same rate.
3. A sum of money doubles in 5 years at simple interest. Find the rate of interest.
4. The population of a city is 100,000 and decreases at 5% per annum. Find population after 3 years.
5. A loan of Rs. 5000 is to be repaid in 3 equal annual installments at 12% interest. Find the installment amount.
