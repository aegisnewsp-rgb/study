...
const exam: ExamTemplate = {
  examId: 'sat-qatar',
  examName: 'SAT (College Board) — Qatar',
  country: 'qatar',
  description: 'The SAT is a college-readiness assessment administered by the College Board and accepted by universities in the United States and internationally. In Qatar, candidates typically register for the SAT through the College Board website and sit the exam at the British Council Doha test centre (the official College Board international test centre for Qatar) or at approved international school testing sites in Doha, including the international schools at Qatar Foundation Education City. The current digital SAT (fully transitioned from the legacy paper SAT, which was retired internationally) is shorter than the previous version, adaptive at the section level (Module 2 difficulty depends on Module 1 performance), and scored on a 400-1600 scale. The optional Essay was retired in 2021. The SAT is widely used by Qatari students applying to undergraduate programmes at US universities and the Education City branch campuses (Carnegie Mellon University in Qatar, Northwestern Qatar, Texas A&M University at Qatar, Georgetown Qatar, Weill Cornell Medicine-Qatar) for scholarship and admissions purposes.',
  ...
  eligibility: 'No formal eligibility criteria. Most candidates are Qatari high-school students in Grade 11 or 12, applying to undergraduate programmes that require or accept the SAT. There is no prerequisite coursework, no minimum age (parental consent required for candidates under 13), and no limit on retakes. International candidates register through the College Board website and pay the international test fee. Test-centre availability, fees, identification requirements and the ID policy on test day vary by country — confirm the live Qatar test centre, accepted ID (passport for non-residents, Qatar ID for residents), and registration windows on https://satsuite.collegeboard.org/ before submission.',
  subjects,
  durations: {
    '1h': makeRoadmap(subjects, '1h', 1, 'Study plan for SAT (Qatar) — 1 Hour'),
    '2h': makeRoadmap(subjects, '2h', 1, 'Study plan for SAT (Qatar) — 2 Hours'),
    '3h': makeRoadmap(subjects, '3h', 1, 'Study plan for SAT (Qatar) — 3 Hours'),
    '5h': makeRoadmap(subjects, '5h', 1, 'Study plan for SAT (Qatar) — 5 Hours'),
    '12h': makeRoadmap(subjects, '12h', 1, 'Study plan for SAT (Qatar) — 12 Hours'),
    '1d': makeRoadmap(subjects, '1d', 1, 'Study plan for SAT (Qatar) — 1 Day'),
    '2d': makeRoadmap(subjects, '2d', 2, 'Study plan for SAT (Qatar) — 2 Days'),
    '3d': makeRoadmap(subjects, '3d', 3, 'Study plan for SAT (Qatar) — 3 Days'),
    '5d': makeRoadmap(subjects, '5d', 5, 'Study plan for SAT (Qatar) — 5 Days'),
    '7d': makeRoadmap(subjects, '7d', 7, 'Study plan for SAT (Qatar) — 1 Week'),
    '10d': makeRoadmap(subjects, '10d', 10, 'Study plan for SAT (Qatar) — 10 Days'),
    '2w': makeRoadmap(subjects, '2w', 14, 'Study plan for SAT (Qatar) — 2 Weeks'),
    '1mo': makeRoadmap(subjects, '1mo', 30, 'Study plan for SAT (Qatar) — 1 Month'),
    '2mo': makeRoadmap(subjects, '2mo', 60, 'Study plan for SAT (Qatar) — 2 Months'),
    '3mo': makeRoadmap(subjects, '3mo', 90, 'Study plan for SAT (Qatar) — 3 Months'),
    '6mo': makeRoadmap(subjects, '6mo', 180, 'Study plan for SAT (Qatar) — 6 Months'),
    '1yr': makeRoadmap(subjects, '1yr', 365, 'Study plan for SAT (Qatar) — 1 Year'),
    '2yr': makeRoadmap(subjects, '2yr', 730, 'Study plan for SAT (Qatar) — 2 Years'),
  },
  rescueMode: {
    name: 'Rescue Mode',
    description: 'Cramming plan for SAT (Qatar)',
    duration: '1d',
    focusAreas: [
  ...
  commonMistakes: [
    ...
    'Failing to confirm the test-centre ID policy before test day — the College Board accepts a passport for non-residents and the Qatar ID for residents, and an incorrect ID on test day can void the registration.',
