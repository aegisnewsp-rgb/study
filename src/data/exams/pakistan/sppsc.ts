...
const exam: ExamTemplate = {
  ...
  prepOverview:
    'SPSC (Sindh) preparation works best in three phases: (1) map the live syllabus and paper pattern from the official notice, (2) finish high-weight topics with timed practice sets and an error log, (3) sit full-length mocks matching official duration and marking. Use StudyRoadmap free roadmaps and topic notes for day-level sequencing. Always re-check registration windows, fees, eligibility and pattern on https://spsc.gos.pk/ for the current cycle — rules change by year and country (pakistan).',
  commonMistakes: [
    'Using outdated SPSC (Sindh) pattern or syllabus PDFs instead of the live official notice.',
  ...
  officialSource: 'https://spsc.gos.pk/',
};
