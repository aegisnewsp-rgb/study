...
**KMP Definition (Section 2(51)) — Key Managerial Personnel**
The following constitute KMP:
...
**Key Powers of Board (Section 179)**
Board collectively can:
...
A person cannot be appointed director if:
...
**Quick Memory Mnemonic — Board Quorum:**
"**1/3 or 2** — quorum is whichever is HIGHER"
- 9 directors → quorum = 3 (1/3 of 9 = 3)
- 5 directors → quorum = 2 (1/3 of 5 = 1.67, rounded up to 2)

**Quick Memory Mnemonic — Director Disqualifications:**
"**U**nsound, **I**nsolvent, **C**onvicted, **C**alls unpaid, **D**eclared disqualified"
- U = Unsound mind
...
**Section 164 — Disqualifications (Full Text):**
...
-Transactions below threshold amounts
