...
**In plants and yeast**:
C₆H₁₂O₆ → 2C₂H₅OH + 2CO₂ + Energy (Alcoholic fermentation)

**In humans and animals (muscle cells during heavy exercise)**:
C₆H₁₂O₆ → 2C₃H₆O₃ + Energy (Lactic acid fermentation)
...
**Asthma**: Bronchi constrict, excess mucus produced — difficulty breathing, wheezing, coughing.
**Bronchitis**: Inflammation of bronchial tubes — common in smokers.
**Pneumonia**: Infection causing alveoli to fill with fluid — oxygen diffusion impaired.
