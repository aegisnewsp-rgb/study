...
Core concept: Topic 2 is an important topic in ('physics', 'Physics') for Makerere University (Uganda)
...
Overview: Topic 2 is a key ('physics', 'Physics') topic for Makerere University (Uganda)
...
Full coverage: Topic 2 in ('physics', 'Physics') for Makerere University (Uganda) preparation
