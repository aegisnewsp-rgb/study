...
- Common CLAT scenarios: surgical instruments left inside patients, building collapse, Delhi public transport accidents
...
- ***Stare Decisis*** — "Let the decision stand." Courts are bound by their own previous decisions (vertical) and by high court decisions (horizontal, in some circumstances). Though Latin, this principle is often tested under "precedent" in CLAT.
