...
Core concept: Topic 12 is an important topic in ('physics', 'Physics') for Gaokao (China)
...
Overview: Topic 12 is a key ('physics', 'Physics') topic for Gaokao (China)
...
Full coverage: Topic 12 in ('physics', 'Physics') for Gaokao (China) preparation
