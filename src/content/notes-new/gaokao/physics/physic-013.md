...
Core concept: Topic 13 is an important topic in ('physics', 'Physics') for Gaokao (China)
...
Overview: Topic 13 is a key ('physics', 'Physics') topic for Gaokao (China)
...
Full coverage: Topic 13 in ('physics', 'Physics') for Gaokao (China) preparation
