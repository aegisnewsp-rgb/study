export const science_stream: Subject = {
  id: 'science-stream', name: 'Science-Stream', color: '#6b7280',
  topics: [
    ...
    { id: 'scienc-013', name: 'Topic 13', weight: 3 as const },
    { id: 'scienc-014', name: 'Topic 14', weight: 3 as const },
    { id: 'scienc-015', name: 'Topic 15', weight: 3 as const }
  ]
};
