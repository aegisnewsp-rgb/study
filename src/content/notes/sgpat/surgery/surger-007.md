...
- **The 5 Ws of postoperative fever** by post-op day (POD): **W**ind POD 1–2, **W**ater POD 3–5, **W**ound POD 5–7, **W**alking POD 4–6, **W**onder drugs POD >7.
- **Parkland formula** = 4 × weight (kg) × %TBSA burned; half in the first 8 hours from the time of burn, the rest over the next 16 hours.

> Mnemonic: **"A S**urgical **W**ound **C**lassifies **I**nfection **R**isk" → clean (I) <1.5%, dirty (IV) >25%.
...
- **[View this topic in your Saudi GP Board roadmap](/roadmap/?exam=sgpat&duration=1mo)** — see where "Topic 7" fits in your personalised plan
