...
Core concept: Topic 8 is an important topic in ('english', 'English') for KUCCPS (Kenya)
...
Overview: Topic 8 is a key ('english', 'English') topic for KUCCPS (Kenya)
...
Full coverage: Topic 8 in ('english', 'English') for KUCCPS (Kenya) preparation
