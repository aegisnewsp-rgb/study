...
Core concept: Topic 4 is an important topic in ('physics', 'Physics') for EGE (Russia)
...
Overview: Topic 4 is a key ('physics', 'Physics') topic for EGE (Russia)
...
Full coverage: Topic 4 in ('physics', 'Physics') for EGE (Russia) preparation
