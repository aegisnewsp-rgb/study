...
Core concept: Topic 3 is an important topic in ('physics', 'Physics') for EGE (Russia)
...
Overview: Topic 3 is a key ('physics', 'Physics') topic for EGE (Russia)
...
Full coverage: Topic 3 in ('physics', 'Physics') for EGE (Russia) preparation
