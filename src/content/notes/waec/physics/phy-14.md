...
**Magnetic Field and Electromagnetism** — Key Facts
...
**Magnetic Field and Electromagnetism** — WAEC WASSCE Study Guide
...
**Magnetic Field and Electromagnetism** — Comprehensive WAEC Physics Notes
...
By Faraday's law, the induced e.m.f.:
$$E = -N\frac{d\Phi}{dt} = -N\frac{d}{dt}(BA\cos\omega t) = NBA\omega\sin\omega t$$
...
Solution:
$F = BIL\sin\theta = 0.2 \times 10 \times 0.5 \times \sin 90°$
$F = 0.2 \times 10 \times 0.5 \times 1 = 1.0$ N
