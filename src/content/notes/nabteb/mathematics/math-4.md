...
topic: math-4
topicName: "Algebra: Expressions and Equations"
weight: 5
country: nigeria
generated: "2026-03-24T08:32:07.548143"
diagramPrompt: "Mathematical diagram showing Algebra: Expressions and Equations concept with coordinate axes, labeled points, geometric shapes shaded appropriately, clean black and white style"
---
...
From (2): $x = y + 2$
Substitute into (1): $2(y+2) + y = 7 \Rightarrow 3y + 4 = 7 \Rightarrow y = 1$
Then $x = 1 + 2 = 3$
Solution: $x = 3, y = 1$
...
Add (1) + (2): $5x = 20 \Rightarrow x = 4$
Substitute: $3(4) + 2y = 16 \Rightarrow 12 + 2y = 16 \Rightarrow y = 2$
...
**Case 3 — Quadratic denominator:**
$$\frac{x+5}{x^2+1} = \text{cannot be split further (unless numerator has degree ≥ denominator)}$$
