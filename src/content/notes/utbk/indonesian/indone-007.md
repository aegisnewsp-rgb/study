...
2. **Map paragraphs** to a one-line summary each; this isolates the **gagasan utama** per paragraph.
3. **Track cohesion devices** — konjungsi, rujukan, ellipsis — to link ideas across sentences.
4. **Mark facts vs opinions** by looking for verifiable claims vs value-laden language (*paling, seharusnya, terbaik*).
5. **Answer inference questions** by combining literal cues with world knowledge; never copy a sentence verbatim if the stem asks for *makna tersirat*.

#### Typical UTBK Question Patterns
- "What is the main idea of paragraph 3?" → answer the most general sentence.
- "The writer's purpose in the second paragraph is to…" → match to communicative aim.
- "Which statement is an opinion?" → flag evaluative adjectives.
- "The word *itu* in line 12 refers to…" → resolve **rujukan**.
...
- Resolving **anafora/katara** by guessing the nearest noun instead of the grammatically and semantically correct antecedent.
- Reading **majas** literally — *mata hatinya menangis* is about emotional pain, not tears from the eye.
- Ignoring the **closing move** of a negotiation; the deal is the communicative payoff, not the dispute.
- Answering "information stated implicitly" with a literal paraphrase.

#### Worked Example
A passage: *"Pemanasan global bukan sekadar isu lingkungan, melainkan ancaman ekonomi. Data IPCC menunjukkan kenaikan suhu 1,1°C telah menekan produktivitas pertanian 3% di zona tropis. Karena itu, transisi energi bukan pilihan, melainkan keharusan."*
Question: *What is the writer's main thesis?* — Answer: energy transition is an economic necessity, not a choice. The marker *karena itu* signals that the statistic supports the thesis; the thesis itself sits in the opening sentence anchored by *bukan… melainkan…*.

#### Practice Prompts
1. Identify the **fakta** and **opini** in a 200-word editorial on online learning.
2. Rewrite a stanza of a poem in **bahasa sendiri** without losing the majas's connotation.
