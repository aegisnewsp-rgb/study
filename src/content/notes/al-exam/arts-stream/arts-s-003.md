...
Herrick's *Noble Numbers* (religious) and *Hesperides* (secular love poems) celebrate beauty, pleasure, and the fleeting nature of life. "To the Virgins, to Make Much of Time" is the quintessential carpe diem poem: "Gather ye rosebuds while ye may, / Old time still flying." The tone is joyful, not intellectual.

**Lord Dorset (Richard Butler, 1640–1697)**
Dorest's "To all Women" and "A Hint to the Poets" show the Cavalier talent for polished, epigrammatic verse.
...
| Term | Definition |
|------|-----------|
| Conceit | An elaborate, extended metaphor; intellectual and startling |
| Carpe diem | "Seize the day" — theme of enjoying the present before time runs out |
| Blank verse | Unrhymed iambic pentameter; standard for English epic |
| Theodicy | A defence of God's goodness despite the existence of evil |
| Baroque | Artistic style of dramatic tension, contrast, and ornate complexity |
| Allegory | Story where characters and events symbolise deeper moral/spiritual truths |
| Scholastic method | Logical, argumentative approach to philosophical questions |
| Blank verse | Unrhymed iambic pentameter; Milton's chosen form for Paradise Lost |
