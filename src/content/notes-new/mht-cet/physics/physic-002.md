...
Core concept: Topic 2 is an important topic in ('physics', 'Physics') for MHT-CET
...
Overview: Topic 2 is a key ('physics', 'Physics') topic for MHT-CET
...
Full coverage: Topic 2 in ('physics', 'Physics') for MHT-CET preparation
