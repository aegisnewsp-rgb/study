...
Core concept: Topic 2 is an important topic in ('physics', 'Physics') for Gaokao (China)
...
Overview: Topic 2 is a key ('physics', 'Physics') topic for Gaokao (China)
...
Full coverage: Topic 2 in ('physics', 'Physics') for Gaokao (China) preparation
