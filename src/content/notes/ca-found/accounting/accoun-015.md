...
Compare current assets and current liabilities at the beginning and end of the period to compute the net change in working capital.

**Step 2 — Compute Funds from Operations**
This is the most-tested calculation in CA Foundation:
...
1. Using **net profit directly** as funds from operations — wrong; must add back non-cash items.
2. Treating **bank overdraft** as a current liability for working capital — it is a non-current liability.
3. Forgetting to adjust **profit or loss on sale** of fixed assets.
4. Missing **tax paid** and **dividend paid** in the applications column.
...
**Part 1 — Statement of Changes in Working Capital**
Lists each current asset and current liability at the beginning and end of the period, showing the increase or decrease in each. Net change = change in working capital.

**Part 2 — Sources of Funds**
Shows all inflows of funds during the period. Funds from operations is the most important internal source, computed by adjusting net profit for all non-cash and non-operating items.
...
1. Treating an increase in a current liability as a source — it is actually a source of funds because it increases working capital.
2. Treating depreciation as a source of funds — it is an **add-back to profit**, not a cash inflow.
3. Including **provision for taxation** in applications when it has not been paid — only actual payment is an application.

## Practice Prompts

1. From the following data, compute Funds from Operations: Net Profit ₹50,000; Depreciation ₹8,000; Goodwill Written Off ₹3,000; Loss on Sale of Machinery ₹2,000; Provision for Doubtful Debts ₹1,500.
2. Prepare a Funds Flow Statement given: Equity capital issued ₹2,00,000; 10% Debentures redeemed ₹50,000; Machinery purchased ₹1,20,000; Dividend paid ₹30,000; Tax paid ₹20,000; Depreciation charged ₹15,000. Closing Working Capital exceeds Opening Working Capital by ₹25,000.
